/** 
 **************************************************************************************
 * @file Facility_Photo_Enum.java
 * @brief 主に[設備写真データ管理]機能において使用する列挙型を格納したファイルである。
 **************************************************************************************
 */ 
...
/** 
 **************************************************************************************
 * @brief 主に[設備写真データ管理]機能において使用する列挙型である。
 * @details 
...
public enum Facility_Photo_Enum {
   ...
   **********************************************************
   */ 
  private Facility_Photo_Enum(String ja_name, String en_name){

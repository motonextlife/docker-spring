/** 
 **************************************************************************************
 * @file Score_Pdf_Enum.java
 * @brief 主に[楽譜データ管理]機能において使用する列挙型を格納したファイルである。
 **************************************************************************************
 */ 
...
/** 
 **************************************************************************************
 * @brief 主に[楽譜データ管理]機能において使用する列挙型である。
 * @details 
...
public enum Score_Pdf_Enum {
   ...
   **********************************************************
   */ 
  private Score_Pdf_Enum(String ja_name, String en_name){

/** 
 **************************************************************************************
 * @file Sound_Source_Enum.java
 * @brief 主に[音源情報管理]機能において使用する列挙型を格納したファイルである。
 **************************************************************************************
 */ 
...
/** 
 **************************************************************************************
 * @brief 主に[音源情報管理]機能において使用する列挙型である。
 * @details 
...
public enum Sound_Source_Enum {
   ...
   **********************************************************
   */ 
  private Sound_Source_Enum(String ja_name, String en_name){

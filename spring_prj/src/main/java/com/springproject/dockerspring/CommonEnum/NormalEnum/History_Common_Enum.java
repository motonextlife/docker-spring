/** 
 **************************************************************************************
 * @file History_Common_Enum.java
 * @brief 主に[全機能共通の履歴情報管理]機能において使用する列挙型を格納したファイルである。
 **************************************************************************************
 */ 
...
/** 
 **************************************************************************************
 * @brief 主に[全機能共通の履歴情報管理]機能において使用する列挙型である。
 * @details 
 ...
 **************************************************************************************
 */ 
public enum History_Common_Enum {
   ...
   **********************************************************
   */ 
  private History_Common_Enum(String ja_name, String en_name){

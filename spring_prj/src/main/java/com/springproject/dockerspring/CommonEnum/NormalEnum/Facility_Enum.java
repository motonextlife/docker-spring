/** 
 **************************************************************************************
 * @file Facility_Enum.java
 * @brief 主に[設備情報管理]機能において使用する列挙型を格納したファイルである。
 **************************************************************************************
 */ 
...
/** 
 **************************************************************************************
 * @brief 主に[設備情報管理]機能において使用する列挙型である。
 * @details 
...
public enum Facility_Enum {
   ...
   **********************************************************
   */ 
  private Facility_Enum(String ja_name, String en_name){

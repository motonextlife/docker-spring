...
/**************************************************************/
/*   [Inspect_Items_Pdf]
/*   エンティティ「Inspect_Items」のデータを用いて、
/*   出力するPDFデータのデザインを行う。
/**************************************************************/

@Component
public class Inspect_Items_Pdf implements Serializable, OutPdf<Inspect_Items>{
  ...
  @Override
  public String makePdf(Inspect_Items entity) throws IOException{
    ...
    try(ByteArrayOutputStream byteout = new ByteArrayOutputStream();
      ...
      this.serial_num = map.get(Inspect_Items_Enum.Serial_Num.getKey());
      ...
      this.inspsheet_date = map.get(Inspect_Items_Enum.Inspsheet_Date.getKey());
      ...
      throw new NullPointerException("Error location [Inspect_Items:makePdf(NullPointerException)]");
    }catch(IOException e){
      throw new IOException("Error location [Inspect_Items:makePdf(IOException)]");
    }catch(ClassCastException e){
      throw new ClassCastException("Error location [Inspect_Items:makePdf(ClassCastException)]");
    }
  ...
  public void designPdf(BufferedOutputStream out) throws IOException{
    ...
    try(Document doc = new Document(pdf, PageSize.A4)){
      ...
      doc.add(new Paragraph(this.inspsheet_name).setFont(font));
      doc.add(new Paragraph(this.inspsheet_date).setFont(font));
      doc.add(new Paragraph(this.insp_item_contents_1).setFont(font));
      doc.add(new Paragraph(this.insp_item_kinds_1).setFont(font));
      doc.add(new Paragraph(this.insp_item_unit_1).setFont(font));
      doc.add(new Paragraph(this.insp_item_contents_2).setFont(font));
      doc.add(new Paragraph(this.insp_item_kinds_2).setFont(font));
      doc.add(new Paragraph(this.insp_item_unit_2).setFont(font));
      doc.add(new Paragraph(this.insp_item_contents_3).setFont(font));
      doc.add(new Paragraph(this.insp_item_kinds_3).setFont(font));
      doc.add(new Paragraph(this.insp_item_unit_3).setFont(font));
      doc.add(new Paragraph(this.insp_item_contents_4).setFont(font));
      doc.add(new Paragraph(this.insp_item_kinds_4).setFont(font));
      doc.add(new Paragraph(this.insp_item_unit_4).setFont(font));
      doc.add(new Paragraph(this.insp_item_contents_5).setFont(font));
      doc.add(new Paragraph(this.insp_item_kinds_5).setFont(font));
      doc.add(new Paragraph(this.insp_item_unit_5).setFont(font));
      doc.add(new Paragraph(this.insp_item_contents_6).setFont(font));
      doc.add(new Paragraph(this.insp_item_kinds_6).setFont(font));
      doc.add(new Paragraph(this.insp_item_unit_6).setFont(font));
      doc.add(new Paragraph(this.insp_item_contents_7).setFont(font));
      doc.add(new Paragraph(this.insp_item_kinds_7).setFont(font));
      doc.add(new Paragraph(this.insp_item_unit_7).setFont(font));
      doc.add(new Paragraph(this.insp_item_contents_8).setFont(font));
      doc.add(new Paragraph(this.insp_item_kinds_8).setFont(font));
      doc.add(new Paragraph(this.insp_item_unit_8).setFont(font));
      doc.add(new Paragraph(this.insp_item_contents_9).setFont(font));
      doc.add(new Paragraph(this.insp_item_kinds_9).setFont(font));
      doc.add(new Paragraph(this.insp_item_unit_9).setFont(font));
      doc.add(new Paragraph(this.insp_item_contents_10).setFont(font));
      doc.add(new Paragraph(this.insp_item_kinds_10).setFont(font));
      doc.add(new Paragraph(this.insp_item_unit_10).setFont(font));
    }
  }
}
...
@Component
@Aspect
public class EquipInspAspect extends CommonAspect implements ComFuncAuth, ComListAuth{

	//対象コントローラーの定義
	@Pointcut("com.springproject.dockerspring.controller.NormalController.EquipInspManage")

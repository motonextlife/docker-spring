...
/**************************************************************/
/*   [RecEvalItemsAspect]
/*   「採用考課シート管理機能」への、権限判断を行う。
/*   なお、判断対象のメソッド名は、末尾の「Auth」を除いて
/*   同一にしてある。
/**************************************************************/
@Component
@Aspect
public class RecEvalItemsAspect extends CommonAspect implements ComFuncAuth{

	//対象コントローラーの定義
	@Pointcut("com.springproject.dockerspring.controller.NormalController.RecEvalItemsManage")

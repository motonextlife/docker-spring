...
/**************************************************************/
/*   [InspectItemsAspect]
/*   「点検シート管理機能」への、権限判断を行う。
/*   なお、判断対象のメソッド名は、末尾の「Auth」を除いて
/*   同一にしてある。
/**************************************************************/
@Component
@Aspect
public class InspectItemsAspect extends CommonAspect implements ComFuncAuth{

	//対象コントローラーの定義
	@Pointcut("com.springproject.dockerspring.controller.NormalController.InspectItemsManage")

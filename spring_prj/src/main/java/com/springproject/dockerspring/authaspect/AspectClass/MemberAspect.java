...
@Component
@Aspect
public class MemberAspect extends CommonAspect implements ComFuncAuth{

	//対象コントローラーの定義
	@Pointcut("com.springproject.dockerspring.controller.NormalController.MemberManage")
	...
	public Object deleteDataAuth(ProceedingJoinPoint jp) {
		return checkAuth(jp, Usage_Authority_Enum.Memb_Info_Delete);
	}

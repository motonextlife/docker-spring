...
@Component
@Aspect
public class FacilityAspect extends CommonAspect implements ComFuncAuth{

	//対象コントローラーの定義
	@Pointcut("com.springproject.dockerspring.controller.NormalController.FacilityManage")
	...
	public Object deleteDataAuth(ProceedingJoinPoint jp) {
		return checkAuth(jp, Usage_Authority_Enum.Facility_Delete);
	}

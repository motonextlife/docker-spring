...
import com.springproject.dockerspring.authaspect.ComListAuth;
...
@Component
@Aspect
public class RecEvalAspect extends CommonAspect implements ComFuncAuth, ComListAuth{

	//対象コントローラーの定義
	@Pointcut("com.springproject.dockerspring.controller.NormalController.RecEvalManage")
	...
	public Object deleteDataAuth(ProceedingJoinPoint jp) {
		return checkAuth(jp, Usage_Authority_Enum.Rec_Eval_Delete);
	}
	...
	@Override
	@Before("execution(* commonPointcut().selectListData (..))")
	public Object selectListDataAuth(ProceedingJoinPoint jp) {
		return checkAuth(jp, Usage_Authority_Enum.Rec_Eval_Brows);
	}
}
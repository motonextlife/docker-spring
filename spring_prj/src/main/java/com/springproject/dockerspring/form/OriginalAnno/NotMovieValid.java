...
/***********************************************************/
/*   [NotMovieValid]
/*   アノテーション「NotMovie」に指定された処理内容として
/*   機能する。
/***********************************************************/

public class NotMovieValid implements ConstraintValidator<NotMovie, Object>{

  private String message;

  @Override
  public void initialize(NotMovie annotation){
...
/****************************************************************/
/*   [isValid]
/*   指定されたファイルの拡張子が「動画」であれば「条件不一致」とする。
...
/****************************************************************/
  ...
  public boolean isValid(Object value, ConstraintValidatorContext context) {
    ...
    if(type.equals(DatatypeEnum.MOVIE.getType())){

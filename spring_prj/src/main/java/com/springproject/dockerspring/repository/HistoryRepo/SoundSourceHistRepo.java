...
/**************************************************************/
/*   [SoundSourceHistRepo]
/*   テーブル「Sound_Source_History」へのデータベース
/*   アクセスを行う。
/**************************************************************/
public interface SoundSourceHistRepo extends CrudRepository<Sound_Source_History, Integer>{
  ...
  Iterable<Sound_Source_History> findAllByDateBetween(
  ...
  @Modifying
  @Query(
    "DELETE FROM Sound_Source_History " + 

/** 
 **************************************************************************************
 * @file Facility_Photo_History.java
 * @brief 主に[設備写真データ変更履歴]機能のデータの、データベース保存やデータのやり取りに使用する
 * エンティティを格納したファイルである。
 **************************************************************************************
 */ 
 ...
 * 
 * @details 
 * - このエンティティが対応するデータベース内のテーブルの名称は[Facility_Photo_History]である。
...
@NoArgsConstructor
@Table("Facility_Photo_History")
public class Facility_Photo_History implements EntitySetUp{

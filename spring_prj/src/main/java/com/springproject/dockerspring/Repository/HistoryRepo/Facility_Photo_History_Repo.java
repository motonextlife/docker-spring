...
/** 
 **************************************************************************************
 * @file Facility_Photo_History_Repo.java
 * @brief 主に[設備写真データ変更履歴]機能で使用する、データベースとの通信を行うリポジトリの
 ...
 * 
 * @details 
 * - このリポジトリが対応するデータベース内のテーブルの名称は[Facility_Photo_History]である。
 ...
 **************************************************************************************
 */ 
public interface Facility_Photo_History_Repo extends FindAllCrudRepository<Facility_Photo_History, Integer>{
   ...
   */
  @Override
  public default FindAllResult<Facility_Photo_History> findAllBranch(FindAllParam param) throws ExecutionException, InterruptedException{
    ...
    if(form_enum.isEmpty() || order == null || max == null || limit == null || offset == null){
      throw new IllegalArgumentException("Error location [Facility_Photo_History_Repo:findAllBranch(IllegalArgumentException)]");
    }


    CompletableFuture<List<Facility_Photo_History>> async_result = null;
    CompletableFuture<Integer> async_count = null;
    List<Facility_Photo_History> result = null;
    Integer count = null;
    ...
    try{
      ...
      throw new ExecutionException("Error location [Facility_Photo_History_Repo:findAllBranch(ExecutionException)]" + "\n" + e, e);
    }catch(InterruptedException e){
      throw new InterruptedException("Error location [Facility_Photo_History_Repo:findAllBranch](InterruptedException)" + "\n" + e);
    }

    return new FindAllResult<Facility_Photo_History>(result, count);
  }
  ...
  @Query("SELECT COUNT(*) FROM" 
      + " (" 
        + " SELECT * FROM Facility_Photo_History" 
   ...
   */     
  @Async("Repo")
  @Query("SELECT * FROM Facility_Photo_History" 
      + " WHERE change_datetime BETWEEN :start_datetime AND :end_datetime" 
      + " ORDER BY change_datetime ASC, history_id ASC" 
      + " LIMIT :limit" 
      + " OFFSET :offset")
  CompletableFuture<List<Facility_Photo_History>> findAllByDateBetween(@Param("start_datetime") Date start_datetime, 
                                                                       @Param("end_datetime") Date end_datetime, 
  ...
  @Query("SELECT * FROM Facility_Photo_History" 
      ...
      + " LIMIT :limit" 
      + " OFFSET :offset")
  CompletableFuture<List<Facility_Photo_History>> findAllByDateBetweenDESC(@Param("start_datetime") Date start_datetime, 
                                                                           @Param("end_datetime") Date end_datetime, 
                                                                           @Param("limit") Integer limit, 
                                                                           @Param("offset") Integer offset); 
  ...
  @Query("SELECT * FROM Facility_Photo_History" 
      ...
      + " LIMIT :limit" 
      + " OFFSET :offset")
  CompletableFuture<List<Facility_Photo_History>> findByFaci_id(@Param("word") String word, 
                                                                @Param("start_datetime") Date start_datetime, 
                                                                @Param("end_datetime") Date end_datetime, 
                                                                @Param("limit") Integer limit, 
                                                                @Param("offset") Integer offset);
  ...
  @Query("SELECT * FROM Facility_Photo_History" 
      ...
      + " LIMIT :limit" 
      + " OFFSET :offset")
  CompletableFuture<List<Facility_Photo_History>> findByFaci_idDESC(@Param("word") String word, 
                                                                    @Param("start_datetime") Date start_datetime, 
                                                                    @Param("end_datetime") Date end_datetime, 
                                                                    @Param("limit") Integer limit, 
                                                                    @Param("offset") Integer offset); 
  ...
  @Query("SELECT * FROM Facility_Photo_History" 
      ...
      + " LIMIT :limit" 
      + " OFFSET :offset")
  CompletableFuture<List<Facility_Photo_History>> findByChange_kinds(@Param("word") String word, 
                                                                     @Param("start_datetime") Date start_datetime, 
                                                                     @Param("end_datetime") Date end_datetime, 
                                                                     @Param("limit") Integer limit, 
                                                                     @Param("offset") Integer offset);
  ...
  @Query("SELECT * FROM Facility_Photo_History" 
      ...
      + " LIMIT :limit" 
      + " OFFSET :offset")
  CompletableFuture<List<Facility_Photo_History>> findByChange_kindsDESC(@Param("word") String word, 
                                                                         @Param("start_datetime") Date start_datetime, 
                                                                         @Param("end_datetime") Date end_datetime, 
                                                                         @Param("limit") Integer limit, 
                                                                         @Param("offset") Integer offset); 
  ...
  @Query("SELECT * FROM Facility_Photo_History" 
      ...
      + " LIMIT :limit" 
      + " OFFSET :offset")
  CompletableFuture<List<Facility_Photo_History>> findByOperation_user(@Param("word") String word, 
                                                                       @Param("start_datetime") Date start_datetime, 
                                                                       @Param("end_datetime") Date end_datetime, 
                                                                       @Param("limit") Integer limit, 
                                                                       @Param("offset") Integer offset);
  ...
  @Query("SELECT * FROM Facility_Photo_History" 
      ...
      + " LIMIT :limit" 
      + " OFFSET :offset")
  CompletableFuture<List<Facility_Photo_History>> findByOperation_userDESC(@Param("word") String word, 
                                                                           @Param("start_datetime") Date start_datetime, 
                                                                           @Param("end_datetime") Date end_datetime, 
                                                                           @Param("limit") Integer limit, 
                                                                           @Param("offset") Integer offset);

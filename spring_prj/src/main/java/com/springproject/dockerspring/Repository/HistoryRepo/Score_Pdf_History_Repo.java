/** 
 **************************************************************************************
 * @file Score_Pdf_History_Repo.java
 * @brief 主に[楽譜データ変更履歴]機能で使用する、データベースとの通信を行うリポジトリの
 ...
 * 
 * @details 
 * - このリポジトリが対応するデータベース内のテーブルの名称は[Score_Pdf_History]である。
 ...
 **************************************************************************************
 */ 
public interface Score_Pdf_History_Repo extends FindAllCrudRepository<Score_Pdf_History, Integer>{
   ...
   */
  @Override
  public default FindAllResult<Score_Pdf_History> findAllBranch(FindAllParam param) throws ExecutionException, InterruptedException{
    ...
    if(form_enum.isEmpty() || order == null || max == null || limit == null || offset == null){
      throw new IllegalArgumentException("Error location [Score_Pdf_History_Repo:findAllBranch(IllegalArgumentException)]");
    }


    CompletableFuture<List<Score_Pdf_History>> async_result = null;
    CompletableFuture<Integer> async_count = null;
    List<Score_Pdf_History> result = null;
    Integer count = null;
    ...
    try{
      ...
      throw new ExecutionException("Error location [Score_Pdf_History_Repo:findAllBranch(ExecutionException)]" + "\n" + e, e);
    }catch(InterruptedException e){
      throw new InterruptedException("Error location [Score_Pdf_History_Repo:findAllBranch](InterruptedException)" + "\n" + e);
    }

    return new FindAllResult<Score_Pdf_History>(result, count);
  }
   ...
   */     
  @Async("Repo")
  @Query("SELECT * FROM Score_Pdf_History" 
      + " WHERE change_datetime BETWEEN :start_datetime AND :end_datetime" 
      + " ORDER BY change_datetime ASC, history_id ASC" 
      + " LIMIT :limit" 
      + " OFFSET :offset")
  CompletableFuture<List<Score_Pdf_History>> findAllByDateBetween(@Param("start_datetime") Date start_datetime, 
                                                                  @Param("end_datetime") Date end_datetime, 
  ...
  @Query("SELECT * FROM Score_Pdf_History" 
      ...
      + " LIMIT :limit" 
      + " OFFSET :offset")
  CompletableFuture<List<Score_Pdf_History>> findAllByDateBetweenDESC(@Param("start_datetime") Date start_datetime, 
                                                                      @Param("end_datetime") Date end_datetime, 
                                                                      @Param("limit") Integer limit, 
                                                                      @Param("offset") Integer offset); 
  ...
  @Query("SELECT * FROM Score_Pdf_History" 
      ...
      + " LIMIT :limit" 
      + " OFFSET :offset")
  CompletableFuture<List<Score_Pdf_History>> findByScore_id(@Param("word") String word, 
                                                            @Param("start_datetime") Date start_datetime, 
                                                            @Param("end_datetime") Date end_datetime, 
                                                            @Param("limit") Integer limit, 
                                                            @Param("offset") Integer offset);
  ...
  @Query("SELECT * FROM Score_Pdf_History" 
      ...
      + " LIMIT :limit" 
      + " OFFSET :offset")
  CompletableFuture<List<Score_Pdf_History>> findByScore_idDESC(@Param("word") String word, 
                                                                @Param("start_datetime") Date start_datetime, 
                                                                @Param("end_datetime") Date end_datetime, 
                                                                @Param("limit") Integer limit, 
                                                                @Param("offset") Integer offset); 
  ...
  @Query("SELECT * FROM Score_Pdf_History" 
      ...
      + " LIMIT :limit" 
      + " OFFSET :offset")
  CompletableFuture<List<Score_Pdf_History>> findByChange_kinds(@Param("word") String word, 
                                                                @Param("start_datetime") Date start_datetime, 
                                                                @Param("end_datetime") Date end_datetime, 
                                                                @Param("limit") Integer limit, 
                                                                @Param("offset") Integer offset);
  ...
  @Query("SELECT * FROM Score_Pdf_History" 
      ...
      + " LIMIT :limit" 
      + " OFFSET :offset")
  CompletableFuture<List<Score_Pdf_History>> findByChange_kindsDESC(@Param("word") String word, 
                                                                    @Param("start_datetime") Date start_datetime, 
                                                                    @Param("end_datetime") Date end_datetime, 
                                                                    @Param("limit") Integer limit, 
                                                                    @Param("offset") Integer offset); 
  ...
  @Query("SELECT * FROM Score_Pdf_History" 
      ...
      + " LIMIT :limit" 
      + " OFFSET :offset")
  CompletableFuture<List<Score_Pdf_History>> findByOperation_user(@Param("word") String word, 
                                                                  @Param("start_datetime") Date start_datetime, 
                                                                  @Param("end_datetime") Date end_datetime, 
                                                                  @Param("limit") Integer limit, 
                                                                  @Param("offset") Integer offset);
  ...
  @Query("SELECT * FROM Score_Pdf_History" 
      ...
      + " LIMIT :limit" 
      + " OFFSET :offset")
  CompletableFuture<List<Score_Pdf_History>> findByOperation_userDESC(@Param("word") String word, 
                                                                      @Param("start_datetime") Date start_datetime, 
                                                                      @Param("end_datetime") Date end_datetime, 
                                                                      @Param("limit") Integer limit, 
                                                                      @Param("offset") Integer offset);

/** 
 **************************************************************************************
 * @file Sound_Source_History_Repo.java
 * @brief 主に[音源管理変更履歴]機能で使用する、データベースとの通信を行うリポジトリの
 ...
 * 
 * @details 
 * - このリポジトリが対応するデータベース内のテーブルの名称は[Sound_Source_History]である。
 ...
 **************************************************************************************
 */ 
public interface Sound_Source_History_Repo extends FindAllCrudRepository<Sound_Source_History, Integer>{
   ...
   */
  @Override
  public default FindAllResult<Sound_Source_History> findAllBranch(FindAllParam param) throws ExecutionException, InterruptedException{
    ...
    if(form_enum.isEmpty() || order == null || max == null || limit == null || offset == null){
      throw new IllegalArgumentException("Error location [Sound_Source_History_Repo:findAllBranch(IllegalArgumentException)]");
    }


    CompletableFuture<List<Sound_Source_History>> async_result = null;
    CompletableFuture<Integer> async_count = null;
    List<Sound_Source_History> result = null;
    Integer count = null;
    ...
    try{
      ...
      throw new ExecutionException("Error location [Sound_Source_History_Repo:findAllBranch(ExecutionException)]" + "\n" + e, e);
    }catch(InterruptedException e){
      throw new InterruptedException("Error location [Sound_Source_History_Repo:findAllBranch](InterruptedException)" + "\n" + e);
    }

    return new FindAllResult<Sound_Source_History>(result, count);
  }
  ...
  @Query("SELECT COUNT(*) FROM" 
      + " (" 
        + " SELECT * FROM Sound_Source_History" 
   ...
   */   
  @Async("Repo")
  @Query("SELECT * FROM Sound_Source_History" 
      + " WHERE change_datetime BETWEEN :start_datetime AND :end_datetime" 
      + " ORDER BY change_datetime ASC, history_id ASC" 
      + " LIMIT :limit" 
      + " OFFSET :offset")
  CompletableFuture<List<Sound_Source_History>> findAllByDateBetween(@Param("start_datetime") Date start_datetime, 
                                                                     @Param("end_datetime") Date end_datetime, 
  ...
  @Query("SELECT * FROM Sound_Source_History" 
      ...
      + " LIMIT :limit" 
      + " OFFSET :offset")
  CompletableFuture<List<Sound_Source_History>> findAllByDateBetweenDESC(@Param("start_datetime") Date start_datetime, 
                                                                         @Param("end_datetime") Date end_datetime, 
                                                                         @Param("limit") Integer limit, 
                                                                         @Param("offset") Integer offset); 
  ...
  @Query("SELECT * FROM Sound_Source_History" 
      ...
      + " LIMIT :limit" 
      + " OFFSET :offset")
  CompletableFuture<List<Sound_Source_History>> findBySound_id(@Param("word") String word, 
                                                               @Param("start_datetime") Date start_datetime, 
                                                               @Param("end_datetime") Date end_datetime, 
                                                               @Param("limit") Integer limit, 
                                                               @Param("offset") Integer offset);
  ...
  @Query("SELECT * FROM Sound_Source_History" 
      ...
      + " LIMIT :limit" 
      + " OFFSET :offset")
  CompletableFuture<List<Sound_Source_History>> findBySound_idDESC(@Param("word") String word, 
                                                                   @Param("start_datetime") Date start_datetime, 
                                                                   @Param("end_datetime") Date end_datetime, 
                                                                   @Param("limit") Integer limit, 
                                                                   @Param("offset") Integer offset); 
  ...
  @Query("SELECT * FROM Sound_Source_History" 
      ...
      + " LIMIT :limit" 
      + " OFFSET :offset")
  CompletableFuture<List<Sound_Source_History>> findByChange_kinds(@Param("word") String word, 
                                                                   @Param("start_datetime") Date start_datetime, 
                                                                   @Param("end_datetime") Date end_datetime, 
                                                                   @Param("limit") Integer limit, 
                                                                   @Param("offset") Integer offset);
  ...
  @Query("SELECT * FROM Sound_Source_History" 
      ...
      + " LIMIT :limit" 
      + " OFFSET :offset")
  CompletableFuture<List<Sound_Source_History>> findByChange_kindsDESC(@Param("word") String word, 
                                                                       @Param("start_datetime") Date start_datetime, 
                                                                       @Param("end_datetime") Date end_datetime, 
                                                                       @Param("limit") Integer limit, 
                                                                       @Param("offset") Integer offset); 
  ...
  @Query("SELECT * FROM Sound_Source_History" 
      ...
      + " LIMIT :limit" 
      + " OFFSET :offset")
  CompletableFuture<List<Sound_Source_History>> findByOperation_user(@Param("word") String word, 
                                                                     @Param("start_datetime") Date start_datetime, 
                                                                     @Param("end_datetime") Date end_datetime, 
                                                                     @Param("limit") Integer limit, 
                                                                     @Param("offset") Integer offset);
  ...
  @Query("SELECT * FROM Sound_Source_History" 
      ...
      + " LIMIT :limit" 
      + " OFFSET :offset")
  CompletableFuture<List<Sound_Source_History>> findByOperation_userDESC(@Param("word") String word, 
                                                                         @Param("start_datetime") Date start_datetime, 
                                                                         @Param("end_datetime") Date end_datetime, 
                                                                         @Param("limit") Integer limit, 
                                                                         @Param("offset") Integer offset); 
   ...
   */  
  @Modifying
  @Query("DELETE FROM Sound_Source_History "
       + "WHERE change_datetime BETWEEN :start_datetime AND :end_datetime")

/** 
 **************************************************************************************
 * @file Delete_Form_Child.java
 * @brief 共通のデータ削除時のフォームバリデーションを行う際に、入れ子となる
...
/** 
 **************************************************************************************
 * @brief 共通の共通のデータ削除時のフォームバリデーションを行う際に、入れ子となる
 * バイナリデータの個別の情報を格納するクラス
 * 
 * @details 
 * - フォーム入力時に受け取る値としては、個別のデータに関連付けられているシリアルナンバー。
 * - このクラスは、[Delete_Form]で入れ子として用いる。
 ...
 */ 
@Data
public class Delete_Form_Child{

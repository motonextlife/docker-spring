/** 
 **************************************************************************************
 * @package com.springproject.dockerspring.CommonTestCaseMaker.Facility.Csv
 * 
 * @brief [設備管理]に関するテストケース生成処理のうち、[CSVファイルの入出力]
...
/** 
 **************************************************************************************
 * @file Facility_Csv_TestCase.java
 * @brief 主に[設備管理]機能のテストにおいて、CSVファイルに関係するテストケースを読み込む
 * クラスを格納するファイル。
 * 
 * @note
 ...
 * - @Component
 * 
 * @see Facility_Csv_Yaml
 **************************************************************************************
 */ 
@Component
public class Facility_Csv_TestCase{
  
  private final Facility_Csv_Yaml csv_yml;
   ...
   **********************************************************************************************
   */ 
  public Facility_Csv_TestCase() throws IOException{

    try(InputStream in_csv_yml = new ClassPathResource("TestCaseFile/Facility/facility-csv.yml").getInputStream()){
      Yaml yaml = new Yaml();
      this.csv_yml = yaml.loadAs(in_csv_yml, Facility_Csv_Yaml.class);
    }
  }

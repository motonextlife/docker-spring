 ...
 * 
 * @brief [共通のフォームバリデーション]に関するテストケース生成処理のうち、[共通の履歴検索]
...
/** 
 **************************************************************************************
 * @file Com_Hist_Get_Form_Yaml.java
 * @brief 主に[共通の履歴情報取得]機能のテストにおいて、フォームバリデーションテストの際に用いる
 ...
 * 
 * @details 
 * - このエンティティが対応するYMLファイルの名称は[com-hist-get-form.yml]である。
 ...
 */ 
@Data
public class Com_Hist_Get_Form_Yaml {

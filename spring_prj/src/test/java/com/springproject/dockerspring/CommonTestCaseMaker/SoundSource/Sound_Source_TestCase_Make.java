/** 
 **************************************************************************************
 * @package com.springproject.dockerspring.CommonTestCaseMaker.SoundSource
 * 
 * @brief テストケース生成クラスのうち、[音源管理]に関するテストケースを生成する
 * 処理のパッケージ
 * 
 * @details
...
/** 
 **************************************************************************************
 * @file Sound_Source_TestCase_Make.java
 * @brief 主に[音源番号]機能のテストにおいて、全てのテストに用いるテストケースを全般的に
 * 生成するクラスを格納するファイル。
 * 
 * @note
...
import com.springproject.dockerspring.CommonTestCaseMaker.SoundSource.Csv.Sound_Source_Csv_TestCase;
import com.springproject.dockerspring.CommonTestCaseMaker.SoundSource.Database.Sound_Source_Database_TestCase;
import com.springproject.dockerspring.CommonTestCaseMaker.SoundSource.FailDatabase.Sound_Source_Fail_Database_TestCase;
import com.springproject.dockerspring.CommonTestCaseMaker.SoundSource.Form.Sound_Source_Form_TestCase;
 ...
 * 
 * @see Sound_Source_Form_TestCase
 * @see Sound_Source_RepoForm_TestCase
 * @see Sound_Source_Csv_TestCase
 * @see Sound_Source_Database_TestCase
 * @see Sound_Source_Fail_Database_TestCase
...
@ComponentScan
@RequiredArgsConstructor(onConstructor = @__(@Autowired))
public class Sound_Source_TestCase_Make{
  
  private final Sound_Source_Form_TestCase form_clazz;
  private final Sound_Source_RepoForm_TestCase repoform_clazz;
  private final Sound_Source_Csv_TestCase csv_clazz;
  private final Sound_Source_Database_TestCase database_clazz;
  private final Sound_Source_Fail_Database_TestCase fail_database_clazz;
  ...
  /** 
   **********************************************************************************************
   * @brief 音源情報を関連付けるためのマップキーの列挙型である。
   * 
   * @details
   * - システム全体のテストクラスで、全般的に用いる。
   **********************************************************************************************
   */ 
  public static enum Sound_Source_TestKeys {
    Serial_Num,
    Sound_Id,
    Upload_Date,
    Song_Title,
  ...
  /** @name [音源情報のフォームバリデーション]に関連するメソッド */
  /** @{ */
  ...
  public List<String> getSoundIdFailedData(Boolean unique_tolerance){
    return this.form_clazz.getSoundIdFailedData(unique_tolerance);
  }
  ...
  public List<String> getUploadDateFailedData(Boolean output_valid){
    return this.form_clazz.getUploadDateFailedData(output_valid);
  }
  ...
  public List<String> getPerformerFailedData(){
    return this.form_clazz.getPerformerFailedData();
  }
  ...
  /** @name [音源情報のエラーのデータベーステスト]に関連するメソッド */
  /** @{ */

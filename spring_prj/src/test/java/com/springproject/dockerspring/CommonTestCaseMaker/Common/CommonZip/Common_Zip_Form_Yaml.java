 ...
 * 
 * @brief [共通のフォームバリデーション]に関するテストケース生成処理のうち、[共通のZIPファイル受付]
...
/** 
 **************************************************************************************
 * @file Common_Zip_Form_Yaml.java
 * @brief 主に[共通のZIPファイル]機能のテストにおいて、フォームバリデーションテストの際に用いる
 ...
 * 
 * @details 
 * - このエンティティが対応するYMLファイルの名称は[common-zip-form.yml]である。
 ...
 */ 
@Data
public class Common_Zip_Form_Yaml {

/** 
 **************************************************************************************
 * @file Facility_Photo_Samba_TestCase.java
 ...
 */ 
@Component
public class Facility_Photo_Samba_TestCase{

  private final ConfigureFactory config_factory;


  //! 基本となるテストケースのファイルパス。これに、テストケースのバイナリファイル名を連結して使用。
  private final String base_file_path = "src/main/resources/TestCaseFile/FacilityPhoto/BlobTestCaseData/setup/";
   ...
   */ 
  @Autowired
  public Facility_Photo_Samba_TestCase(ConfigureFactory config_factory) throws IOException{

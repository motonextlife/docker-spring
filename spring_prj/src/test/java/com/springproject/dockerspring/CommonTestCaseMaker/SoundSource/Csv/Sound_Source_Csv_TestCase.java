/** 
 **************************************************************************************
 * @package com.springproject.dockerspring.CommonTestCaseMaker.SoundSource.Csv
 * 
 * @brief [音源管理]に関するテストケース生成処理のうち、[CSVファイルの入出力]
...
/** 
 **************************************************************************************
 * @file Sound_Source_Csv_TestCase.java
 * @brief 主に[音源管理]機能のテストにおいて、CSVファイルに関係するテストケースを読み込む
 * クラスを格納するファイル。
 * 
 * @note
 ...
 * - @Component
 * 
 * @see Sound_Source_Csv_Yaml
 **************************************************************************************
 */ 
@Component
public class Sound_Source_Csv_TestCase{
  
  private final Sound_Source_Csv_Yaml csv_yml;
   ...
   * @throw IOException
   * 
   * @see Musical_Score_Csv_Yaml
   **********************************************************************************************
   */
  public Sound_Source_Csv_TestCase() throws IOException{

    try(InputStream in_csv_yml = new ClassPathResource("TestCaseFile/SoundSource/sound-source-csv.yml").getInputStream()){
      Yaml yaml = new Yaml();
      this.csv_yml = yaml.loadAs(in_csv_yml, Sound_Source_Csv_Yaml.class);
    }
  }

/** 
 **************************************************************************************
 * @file Facility_Photo_Fail_Samba_TestCase.java
 * @brief 主に[設備写真データ情報]機能のテストにおいて、ファイルサーバーとの通信テストの際に
 ...
 */ 
@Component
public class Facility_Photo_Fail_Samba_TestCase{

  private final ConfigureFactory config_factory;

  //! 基本となるテストケースのファイルパス。これに、テストケースのバイナリファイル名を連結して使用。
  private final String base_file_path = "src/main/resources/TestCaseFile/FacilityPhoto/BlobTestCaseData/form/";
   ...
   */ 
  @Autowired
  public Facility_Photo_Fail_Samba_TestCase(ConfigureFactory config_factory) throws IOException{
  ...
  public String failSambaSetup(String testcase_file, String filename) throws IOException{
    return this.config_factory.sambaOutput(this.base_file_path + testcase_file, "FacilityPhoto/normal/" + filename);
  }
  ...
  public void failSambaReset() throws IOException{
    this.config_factory.sambaClear("FacilityPhoto/normal/");
  }  
  ...
  public String historyFailSambaSetup(String testcase_file, String filename) throws IOException{
    return this.config_factory.sambaHistoryOutput(this.base_file_path + testcase_file, "FacilityPhoto/history/" + filename);
  }
  ...
  public void historyFailSambaReset() throws IOException{
    this.config_factory.sambaClear("FacilityPhoto/history/");
  }
}

...
public class Musical_Score_HistInput_Test implements Entity_HistInput_Test{
  ...
  public void 入力した履歴用エンティティデータの同一性確認() throws ParseException{
    ...
    Musical_Score entity = new Musical_Score(depend_hist);

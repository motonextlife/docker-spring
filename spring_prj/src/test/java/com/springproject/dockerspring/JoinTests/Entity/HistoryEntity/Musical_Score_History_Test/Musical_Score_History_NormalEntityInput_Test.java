/** 
 **************************************************************************************
 * @package com.springproject.dockerspring.JoinTests.Entity.HistoryEntity.Musical_Score_History_Test
 * 
 * @brief 履歴用エンティティの結合テストのうち、[楽譜情報変更履歴]に関するテストを格納したパッケージ
 * 
 * @details
 * - このパッケージは、楽譜情報変更履歴で用いるエンティティの結合テストを格納する。
 **************************************************************************************
 */ 
package com.springproject.dockerspring.JoinTests.Entity.HistoryEntity.Musical_Score_History_Test;
...
public class Musical_Score_History_NormalEntityInput_Test implements Entity_NormalEntityInput_Test{
  ...
  public void 入力した通常エンティティデータの同一性確認() throws ParseException{
    ...
    Musical_Score_History entity = new Musical_Score_History(depend_entity, 
  ...
  public void 登録履歴種別の同一性確認(){
    ...
    for(int i = 0; i < size; i++){
      entity = new Musical_Score_History(depend_entity, hist_enum[i], null, null);

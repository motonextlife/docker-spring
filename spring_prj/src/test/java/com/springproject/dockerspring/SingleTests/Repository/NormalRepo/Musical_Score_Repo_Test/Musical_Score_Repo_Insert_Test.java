/** 
 **************************************************************************************
 * @file Musical_Score_Repo_Insert_Test.java
 * @brief 主に[楽譜管理]のリポジトリクラスで、データの新規追加を行うメソッドのテストを行う
 * クラスを格納したファイル。
 **************************************************************************************
 */ 
...
/** 
 **************************************************************************************
 * @brief 主に[楽譜管理]のリポジトリクラスで、データの新規追加を行うメソッドのテストを
 * 行うクラス
 * 
 * @details 
...
public class Musical_Score_Repo_Insert_Test{
   ...
   */
  @Autowired
  public void testcaseSetup(Musical_Score_TestCase_Make testcase, Musical_Score_Repo test_repo){

    Musical_Score_Repo_Insert_Test.testcase = testcase;
    Musical_Score_Repo_Insert_Test.test_repo = test_repo;
    ...
    Musical_Score_Repo_Insert_Test.compare_entity = compare_entity;
    Musical_Score_Repo_Insert_Test.just_entity = Score_Quad_Repository_TestUtils
                                                 .MockToReal(testcase.justInTimeEntityMake());
    Musical_Score_Repo_Insert_Test.null_entity = Score_Quad_Repository_TestUtils
                                                 .MockToReal(testcase.okNullEntityMake());
    Musical_Score_Repo_Insert_Test.unique_miss = Score_Quad_Repository_TestUtils
                                                 .MockToReal(testcase.UniqueMissEntityMake());

    List<Musical_Score> failed_ent_tmp = testcase.failedEntityMake();
    Musical_Score_Repo_Insert_Test.failed_entity = new ArrayList<>();

    for(Musical_Score fail_ent: failed_ent_tmp){
      Musical_Score_Repo_Insert_Test.failed_entity.add(Score_Quad_Repository_TestUtils.MockToReal(fail_ent));
    }
  }
  ...
  public class Insert_Success {
    ...
    public Insert_Success() throws IOException{
      this.test_repo = Musical_Score_Repo_Insert_Test.test_repo;
      this.compare_entity = Musical_Score_Repo_Insert_Test.compare_entity;
      this.just_entity = Musical_Score_Repo_Insert_Test.just_entity;
      this.null_entity = Musical_Score_Repo_Insert_Test.null_entity;
      this.softly = Musical_Score_Repo_Insert_Test.softly;

      Musical_Score_Repo_Insert_Test.testcase.databaseReset();
    }
    ...
    public void 新規追加の成功ケース(){
      ...
      for(Musical_Score ent: this.compare_entity){
        ent.setSerial_num(null);
        this.test_repo.save(ent);

        List<Musical_Score> result = (List<Musical_Score>)this.test_repo.findAll();
      ...
      List<Musical_Score> after = (List<Musical_Score>)this.test_repo.findAll();
      ...
      List<Musical_Score> nulled = (List<Musical_Score>)this.test_repo.findAll();
  ...
  public class Insert_Failed {
    ...
    public Insert_Failed() throws IOException{
      this.test_repo = Musical_Score_Repo_Insert_Test.test_repo;
      this.failed_entity = Musical_Score_Repo_Insert_Test.failed_entity;
      this.softly = Musical_Score_Repo_Insert_Test.softly;
  ...
  public class Unique_Failed {
    ...
    public Unique_Failed() throws IOException{
      this.test_repo = Musical_Score_Repo_Insert_Test.test_repo;
      this.unique_miss = Musical_Score_Repo_Insert_Test.unique_miss;
      this.softly = Musical_Score_Repo_Insert_Test.softly;

      Musical_Score_Repo_Insert_Test.testcase.databaseSetup();
    }

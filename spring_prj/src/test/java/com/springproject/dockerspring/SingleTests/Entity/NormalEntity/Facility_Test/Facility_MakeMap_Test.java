/** 
 **************************************************************************************
 * @file Facility_MakeMap_Test.java
 * 
 * @brief [設備管理]において、エンティティ内部のデータを画面出力用に文字列に変換して
 ...
 * 
 * @details 
 * - 検査対象のクラス名は[Facility]で、検査対象メソッドは[makeMap]である。
...
public class Facility_MakeMap_Test implements Entity_MakeMap_Test{

/** 
 **************************************************************************************
 * @file Sound_Source_CsvImpl_OutputTemp_Test.java
 * @brief 主に[音源管理]のCSVテンプレート出力機能のテストを行うクラスを格納したファイル。
 * 
...
/** 
 **************************************************************************************
 * @brief 主に[音源管理]のCSVテンプレート出力機能のテストを行うクラス
 * 
 * @details 
...
public class Sound_Source_CsvImpl_OutputTemp_Test implements CsvProcess_OutputTemp_Test{
  ...
  private final String prefix = "SoundSourceCsvImplOutputTempTest";
   ...
   */
  @Autowired
  public Sound_Source_CsvImpl_OutputTemp_Test(Sound_Source_TestCase_Make testcase){
  ...
  public void 集約クラス側のCSVテンプレート出力機能の動作確認() throws IOException{
    ...
    File tmp_file_path = this.sound_csv.outputTemplate();

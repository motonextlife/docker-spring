/** 
 **************************************************************************************
 * @file Facility_History_Repo_FindAllBranch_Test.java
 * @brief 主に[設備情報変更履歴]のリポジトリクラスで、検索メソッドの分岐と実行を行うメソッドの
 * テストを行うクラスを格納したファイル。
 **************************************************************************************
 */ 
...
public class Facility_History_Repo_FindAllBranch_Test{
   ...
   */
  @Autowired
  public Facility_History_Repo_FindAllBranch_Test(Facility_History_Repo test_repo, 
  ...
  private void configStaticSet(){
    Facility_History_Repo_FindAllBranch_Test.testcase_static = this.testcase;
  }
   ...
   **********************************************************************************************
   */
  private void findAllBranchCheck(TestParamBuilder<Facility_History> test_builder) 
  ...
  public void 検索分岐メソッドにおいて検索種別が履歴日時の際のテスト() throws InterruptedException, ExecutionException, ParseException{
    ...
    for(int i = 1; i <= 20; i++){
      ...
      TestParam<Facility_History> test_builder = TestParam.<Facility_History>builder()
  ...
  public static void testcaseReset() throws IOException{
    Facility_History_Repo_FindAllBranch_Test.testcase_static.historyDatabaseReset();
  }
}

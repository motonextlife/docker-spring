/** 
 **************************************************************************************
 * @file Musical_Score_MakeMap_Test.java
 * 
 ...
 * 
 * @details 
 * - 検査対象のクラス名は[Musical_Score]で、検査対象メソッドは[makeMap]である。
...
public class Musical_Score_MakeMap_Test implements Entity_MakeMap_Test{

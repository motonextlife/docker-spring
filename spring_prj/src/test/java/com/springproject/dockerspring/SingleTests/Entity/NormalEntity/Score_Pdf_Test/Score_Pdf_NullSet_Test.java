/** 
 **************************************************************************************
 * @file Score_Pdf_NullSet_Test.java
 * 
 ...
 * 
 * @details 
 * - 検査対象のクラス名は[Score_Pdf]で、検査対象メソッドは[stringSetNull]である。
 ...
 **************************************************************************************
 */ 
public class Score_Pdf_NullSet_Test implements Entity_NullSet_Test{
   ...
   ****************************************************************************************
   */ 
  private void assertAllNull(Score_Pdf entity){

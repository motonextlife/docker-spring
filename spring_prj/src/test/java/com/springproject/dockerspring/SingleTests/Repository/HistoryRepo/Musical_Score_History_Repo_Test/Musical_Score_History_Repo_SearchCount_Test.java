/** 
 **************************************************************************************
 * @file Musical_Score_History_Repo_SearchCount_Test.java
 * @brief 主に[楽譜情報変更履歴]のリポジトリクラスで、独自に追加した検索結果を取得するメソッドと
...
public class Musical_Score_History_Repo_SearchCount_Test{
  ...
  private final List<Musical_Score_History> origin_compare;
   ...
   */
  @Autowired
  public Musical_Score_History_Repo_SearchCount_Test(Musical_Score_History_Repo test_repo, 
  ...
  private void configStaticSet(){
    Musical_Score_History_Repo_SearchCount_Test.testcase_static = this.testcase;
  }
   ...
   **********************************************************************************************
   */
  private void findAllSearchCheck(Function<TestParam<Musical_Score_History>, CompletableFuture<List<Musical_Score_History>>> find_all_method, 
                                  TestParamBuilder<Musical_Score_History> test_builder) 
                                  throws ExecutionException, InterruptedException{

    BiConsumer<Musical_Score_History, Musical_Score_History> assert_method = (compare, result) -> {
      Score_Quad_Repository_TestUtils.assertAllEquals(compare, result, this.softly, true);
    };

    TestParam<Musical_Score_History> test_param = test_builder.assert_method(assert_method)
                                                           .softly(this.softly)
                                                           .build();
  ...
  public void 検索対象のカラムが履歴日時の際のテスト() throws InterruptedException, ExecutionException, ParseException{
    ...
    for(int i = 1; i <= 20; i++){
      ...
      CompareParam<Musical_Score_History> list_builder = CompareParam
      ...
      List<Musical_Score_History> compare_1 = Common_Repository_TestUtils
                                  .compareListMake(list_builder.toBuilder()
                                                               .sort_first(Comparator.comparing(Musical_Score_History::getChange_datetime))
                                                               .sort_second(Comparator.comparing(Musical_Score_History::getHistory_id))
                                                               .build());
      List<Musical_Score_History> compare_2 = Common_Repository_TestUtils
                                  .compareListMake(list_builder.toBuilder()
                                                               .sort_first(Comparator.comparing(Musical_Score_History::getChange_datetime, 
      ...
      Function<TestParam<Musical_Score_History>, CompletableFuture<List<Musical_Score_History>>> find_all_method_1 = s -> {
        return this.test_repo.findAllByDateBetween(s.getStart_datetime(), s.getEnd_datetime(), s.getLimit(), s.getOffset());
      };

      Function<TestParam<Musical_Score_History>, CompletableFuture<List<Musical_Score_History>>> find_all_method_2 = s -> {
        return this.test_repo.findAllByDateBetweenDESC(s.getStart_datetime(), s.getEnd_datetime(), s.getLimit(), s.getOffset());
      };

      TestParam<Musical_Score_History> test_builder = TestParam.<Musical_Score_History>builder().start_datetime(start)
                                                                                                .end_datetime(end)
                                                                                                .limit(limit)
                                                                                                .offset(offset)
                                                                                                .all_judge(true)
  ...
  public void 検索対象のカラムが楽譜番号の際のテスト() throws InterruptedException, ExecutionException, ParseException{
    ...
    for(int i = 1; i <= 20; i++){
      ...
      List<Musical_Score_History> compare_1 = Common_Repository_TestUtils
                                  .compareListMake(list_builder.toBuilder()
                                                               .sort_first(Comparator.comparing(Musical_Score_History::getScore_id))
                                                               .sort_second(Comparator.comparing(Musical_Score_History::getChange_datetime))
                                                               .sort_third(Comparator.comparing(Musical_Score_History::getHistory_id))
                                                               .build());
      List<Musical_Score_History> compare_2 = Common_Repository_TestUtils
                                  .compareListMake(list_builder.toBuilder()
                                                               .sort_first(Comparator.comparing(Musical_Score_History::getScore_id, 
      ...
      TestParam<Musical_Score_History> test_builder = TestParam.<Musical_Score_History>builder().main_word(word)
  ...
  public void 検索対象のカラムが操作ユーザー名の際のテスト() throws InterruptedException, ExecutionException, ParseException{
    ...
    for(int i = 1; i <= 20; i++){
      ...
      List<Musical_Score_History> compare_1 = Common_Repository_TestUtils
                                  .compareListMake(list_builder.toBuilder()
                                                               .sort_first(Comparator.comparing(Musical_Score_History::getOperation_user))
                                                               .sort_second(Comparator.comparing(Musical_Score_History::getChange_datetime))
                                                               .sort_third(Comparator.comparing(Musical_Score_History::getHistory_id))
                                                               .build());
      List<Musical_Score_History> compare_2 = Common_Repository_TestUtils
  ...
  public static void testcaseReset() throws IOException{
    Musical_Score_History_Repo_SearchCount_Test.testcase_static.historyDatabaseReset();
  }
}

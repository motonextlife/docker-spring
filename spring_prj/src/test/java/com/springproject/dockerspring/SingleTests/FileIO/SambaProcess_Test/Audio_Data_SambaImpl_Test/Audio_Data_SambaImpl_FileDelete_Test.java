/** 
 **************************************************************************************
 * @file Audio_Data_SambaImpl_FileDelete_Test.java
 * @brief 主に[音源データ管理]のファイルサーバーのデータ削除機能のテストを行うクラスを格納した
 * ファイル。
 **************************************************************************************
 */ 
...
/** 
 **************************************************************************************
 * @brief 主に[音源データ管理]のファイルサーバーのデータ削除機能のテストを行うクラス
 * 
 * @details 
...
public class Audio_Data_SambaImpl_FileDelete_Test implements SambaProcess_FileDelete_Test{

  private final Audio_Data_TestCase_Make testcase;
  private final Audio_Data_Samba faci_samba;
  ...
  private final String prefix = "AudioDataSambaImplFileDeleteTest";
  ...
  private void configStaticSet(){
    Audio_Data_SambaImpl_FileDelete_Test.config_static = this.config;
  }
  ...
  private void fileDeleteCheck(String delete_filename, String remain_filename, String ext, Boolean hist)
    ...
    String delete_filename_path = Sound_Double_Component_TestUtils.sambaMakePath(delete_filename, ext, hist, this.config);
    String remain_filename_path = Sound_Double_Component_TestUtils.sambaMakePath(remain_filename, ext, hist, this.config);

    try(SmbFile smb = new SmbFile(delete_filename_path, Sound_Double_Component_TestUtils.sambaTestSetup(this.config))) {
      this.softly.assertThat(smb.exists()).isFalse();
    }

    try(SmbFile smb = new SmbFile(remain_filename_path, Sound_Double_Component_TestUtils.sambaTestSetup(this.config))) {
  ...
  public void 共通クラス側のファイルサーバー内のデータ削除機能の動作確認() throws IOException{
    ...
    File normal_file = Sound_Double_Component_TestUtils.
    ...
    Sound_Double_Component_TestUtils.preparaSambaData(normal_file, normal_path_1, this.config, false);
    Sound_Double_Component_TestUtils.preparaSambaData(normal_file, normal_path_2, this.config, false);
    Sound_Double_Component_TestUtils.preparaSambaData(hist_file, history_path_1, this.config, false);
    Sound_Double_Component_TestUtils.preparaSambaData(hist_file, history_path_2, this.config, false);
    ...
    Sound_Double_Component_TestUtils.deleteTmpFileCheck(hist_file, this.softly);
    Sound_Double_Component_TestUtils.deleteSambaFileCheck("2", this.ext, false, this.config, this.softly);
    Sound_Double_Component_TestUtils.deleteSambaFileCheck("2", this.hist_ext, true, this.config, this.softly);
  ...
  public static void ファイルサーバーと一時ファイルディレクトリの初期化確認() throws InterruptedException, IOException{
    ...
    Sound_Double_Component_TestUtils.checkSambaClear(Audio_Data_SambaImpl_FileDelete_Test.config_static);
  }
}

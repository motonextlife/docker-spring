/** 
 **************************************************************************************
 * @file Facility_Photo_History_Repo_SearchCount_Test.java
 * @brief 主に[設備写真データ変更履歴]のリポジトリクラスで、独自に追加した検索結果を取得するメソッドと
 ...
 **************************************************************************************
 */ 
@Import({Facility_Photo_TestCase_Make.class, RepoConfig.class})
@EnableAsync
@DataJdbcTest
@AutoConfigureTestDatabase(replace = Replace.NONE)
public class Facility_Photo_History_Repo_SearchCount_Test{
  ...
  private final List<Facility_Photo_History> origin_compare;
   ...
   */
  @Autowired
  public Facility_Photo_History_Repo_SearchCount_Test(Facility_Photo_History_Repo test_repo, 
                                                      Facility_Photo_TestCase_Make testcase) throws IOException{
  ...
  private void configStaticSet(){
    Facility_Photo_History_Repo_SearchCount_Test.testcase_static = this.testcase;
  }
   ...
   **********************************************************************************************
   */
  private void findAllSearchCheck(Function<TestParam<Facility_Photo_History>, CompletableFuture<List<Facility_Photo_History>>> find_all_method, 
                                  TestParamBuilder<Facility_Photo_History> test_builder) 
                                  throws ExecutionException, InterruptedException{

    BiConsumer<Facility_Photo_History, Facility_Photo_History> assert_method = (compare, result) -> {
      Facility_Quad_Repository_TestUtils.assertAllEquals(compare, result, this.softly, true);
    };

    TestParam<Facility_Photo_History> test_param = test_builder.assert_method(assert_method)
                                                               .softly(this.softly)
                                                               .build();
  ...
  public void 検索対象のカラムが履歴日時の際のテスト() throws InterruptedException, ExecutionException, ParseException{
    ...
    for(int i = 1; i <= 20; i++){
      ...
      CompareParam<Facility_Photo_History> list_builder = CompareParam
                                           .<Facility_Photo_History>builder()
      ...
      List<Facility_Photo_History> compare_1 = Common_Repository_TestUtils
                                   .compareListMake(list_builder.toBuilder()
                                                                .sort_first(Comparator.comparing(Facility_Photo_History::getChange_datetime))
                                                                .sort_second(Comparator.comparing(Facility_Photo_History::getHistory_id))
                                                                .build());
      List<Facility_Photo_History> compare_2 = Common_Repository_TestUtils
                                   .compareListMake(list_builder.toBuilder()
                                                                .sort_first(Comparator.comparing(Facility_Photo_History::getChange_datetime, 
      ...
      Function<TestParam<Facility_Photo_History>, CompletableFuture<List<Facility_Photo_History>>> find_all_method_1 = s -> {
        return this.test_repo.findAllByDateBetween(s.getStart_datetime(), s.getEnd_datetime(), s.getLimit(), s.getOffset());
      };

      Function<TestParam<Facility_Photo_History>, CompletableFuture<List<Facility_Photo_History>>> find_all_method_2 = s -> {
        return this.test_repo.findAllByDateBetweenDESC(s.getStart_datetime(), s.getEnd_datetime(), s.getLimit(), s.getOffset());
      };

      TestParam<Facility_Photo_History> test_builder = TestParam.<Facility_Photo_History>builder().start_datetime(start)
                                                                                                  .end_datetime(end)
                                                                                                  .limit(limit)
                                                                                                  .offset(offset)
                                                                                                  .all_judge(true)
  ...
  public void 検索対象のカラムが設備番号の際のテスト() throws InterruptedException, ExecutionException, ParseException{
    ...
    for(int i = 1; i <= 20; i++){
      ...
      List<Facility_Photo_History> compare_1 = Common_Repository_TestUtils
                                   .compareListMake(list_builder.toBuilder()
                                                                .sort_first(Comparator.comparing(Facility_Photo_History::getFaci_id))
                                                                .sort_second(Comparator.comparing(Facility_Photo_History::getChange_datetime))
                                                                .sort_third(Comparator.comparing(Facility_Photo_History::getHistory_id))
                                                                .build());
      List<Facility_Photo_History> compare_2 = Common_Repository_TestUtils
                                   .compareListMake(list_builder.toBuilder()
                                                                .sort_first(Comparator.comparing(Facility_Photo_History::getFaci_id, 
      ...
      TestParam<Facility_Photo_History> test_builder = TestParam.<Facility_Photo_History>builder().main_word(word)
  ...
  public void 検索対象のカラムが操作ユーザー名の際のテスト() throws InterruptedException, ExecutionException, ParseException{
    ...
    for(int i = 1; i <= 20; i++){
      ...
      List<Facility_Photo_History> compare_1 = Common_Repository_TestUtils
                                  .compareListMake(list_builder.toBuilder()
                                                               .sort_first(Comparator.comparing(Facility_Photo_History::getOperation_user))
                                                               .sort_second(Comparator.comparing(Facility_Photo_History::getChange_datetime))
                                                               .sort_third(Comparator.comparing(Facility_Photo_History::getHistory_id))
                                                               .build());
      List<Facility_Photo_History> compare_2 = Common_Repository_TestUtils
  ...
  public static void testcaseReset() throws IOException{
    Facility_Photo_History_Repo_SearchCount_Test.testcase_static.historyDatabaseReset(false);
  }
}

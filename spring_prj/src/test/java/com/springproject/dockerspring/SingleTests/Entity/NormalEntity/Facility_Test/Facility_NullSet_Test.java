/** 
 **************************************************************************************
 * @file Facility_NullSet_Test.java
 * 
 * @brief [設備管理]において、エンティティ内部に格納されているデータをNull初期化する
 ...
 * 
 * @details 
 * - 検査対象のクラス名は[Facility]で、検査対象メソッドは[stringSetNull]である。
 ...
 **************************************************************************************
 */ 
public class Facility_NullSet_Test implements Entity_NullSet_Test{

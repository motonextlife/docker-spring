/** 
 **************************************************************************************
 * @file Facility_Photo_History_NullSet_Test.java
 * 
 * @brief [設備写真データ変更履歴]において、エンティティ内部に格納されているデータをNull初期化する
 ...
 * 
 * @details 
 * - 検査対象のクラス名は[Facility_Photo_History]で、検査対象メソッドは[stringSetNull]である。
 ...
 **************************************************************************************
 */ 
public class Facility_Photo_History_NullSet_Test implements Entity_NullSet_Test{
   ...
   ****************************************************************************************
   */ 
  private void assertAllNull(Facility_Photo_History entity){

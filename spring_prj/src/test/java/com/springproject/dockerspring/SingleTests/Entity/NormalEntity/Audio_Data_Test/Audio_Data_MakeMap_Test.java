/** 
 **************************************************************************************
 * @package com.springproject.dockerspring.SingleTests.Entity.NormalEntity
 * 
 * @brief エンティティの単体テストのうち、[通常用エンティティ]に関するテストを格納するパッケージ
 * 
 * @details
 * - このパッケージは、通常用のエンティティに対して、対となる履歴用エンティティやフォームクラスから
 * データを正常に移し替えできるかだったり、格納中のデータを正常に文字列として出力できるかテストする
 * クラスを格納する。
 **************************************************************************************
 */ 
...
/** 
 **************************************************************************************
 * @package com.springproject.dockerspring.SingleTests.Entity.NormalEntity.Audio_Data_Test
 * 
 * @brief 通常用エンティティのうち、[音源データ管理]に関するテストを格納するパッケージ
 * 
 * @details
 * - このパッケージは、音源データ管理のテストを行うクラスを格納する。
 **************************************************************************************
 */ 
package com.springproject.dockerspring.SingleTests.Entity.NormalEntity.Audio_Data_Test;
...
/** 
 **************************************************************************************
 * @file Audio_Data_MakeMap_Test.java
 * 
 * @brief [音源データ管理]において、エンティティ内部のデータを画面出力用に文字列に変換して
...
/** 
 **************************************************************************************
 * @brief [音源データ管理]において、エンティティ内部のデータを画面出力用に文字列に変換して出力する
 * メソッドをテストするクラス
 * 
 * @details 
 * - 検査対象のクラス名は[Audio_Data]で、検査対象メソッドは[makeMap]である。
...
public class Audio_Data_MakeMap_Test implements Entity_MakeMap_Test{
  ...
  private void setInitTargetEntity(String str){
    ...
    Audio_Data entity = new Audio_Data();

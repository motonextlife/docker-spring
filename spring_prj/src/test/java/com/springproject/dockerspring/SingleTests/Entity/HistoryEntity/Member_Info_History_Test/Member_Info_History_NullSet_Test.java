/** 
 **************************************************************************************
 * @file Member_Info_History_NullSet_Test.java
 * 
 * @brief  [団員情報変更履歴]において、エンティティ内部に格納されているデータをNull初期化する
 ...
 * 
 * @details 
 * - 検査対象のクラス名は[Member_Info_History]で、検査対象メソッドは[stringSetNull]である。
 ...
 **************************************************************************************
 */ 
public class Member_Info_History_NullSet_Test implements Entity_NullSet_Test{

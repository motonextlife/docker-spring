/** 
 **************************************************************************************
 * @file Audio_Data_History_Repo_Insert_Test.java
 * @brief 主に[音源データ変更履歴]のリポジトリクラスで、データの新規追加を行うメソッドのテストを行う
 * クラスを格納したファイル。
 **************************************************************************************
 */ 
...
/** 
 **************************************************************************************
 * @brief 主に[音源データ変更履歴]のリポジトリクラスで、データの新規追加を行うメソッドのテストを
 * 行うクラス
 * 
 * @details 
 ...
 **************************************************************************************
 */ 
@Import(Audio_Data_TestCase_Make.class)
@DataJdbcTest
@AutoConfigureTestDatabase(replace = Replace.NONE)
public class Audio_Data_History_Repo_Insert_Test{
  
  public static Audio_Data_TestCase_Make testcase;
  public static Audio_Data_History_Repo test_repo;
  public static List<Audio_Data_History> compare_entity;
  public static Audio_Data_History just_entity;
  public static List<Audio_Data_History> failed_entity;
   ...
   */
  @Autowired
  public void testcaseSetup(Audio_Data_TestCase_Make testcase, Audio_Data_History_Repo test_repo) throws IOException{
    Audio_Data_History_Repo_Insert_Test.testcase = testcase;
    Audio_Data_History_Repo_Insert_Test.test_repo = test_repo;

    List<Audio_Data_History> compare_entity = new ArrayList<>();
    for(int i = 1; i <= 20; i++){
      compare_entity.add(Sound_Quad_Repository_TestUtils.MockToReal(testcase.compareHistoryEntityMake(i, false)));
    }

    Audio_Data_History_Repo_Insert_Test.compare_entity = compare_entity;
    Audio_Data_History_Repo_Insert_Test.just_entity = Sound_Quad_Repository_TestUtils
                                                      .MockToReal(testcase.justInTimeHistoryEntityMake());

    List<Audio_Data_History> failed_ent_tmp = testcase.failedHistoryEntityMake();
    Audio_Data_History_Repo_Insert_Test.failed_entity = new ArrayList<>();

    for(Audio_Data_History fail_ent: failed_ent_tmp){
      Audio_Data_History_Repo_Insert_Test.failed_entity.add(Sound_Quad_Repository_TestUtils.MockToReal(fail_ent));
    }
  }
  ...
  public class Insert_Success {
    ...
    private final List<Audio_Data_History> compare_entity;
    private final Audio_Data_History just_entity;
    ...
    public Insert_Success() throws IOException{
      this.test_repo = Audio_Data_History_Repo_Insert_Test.test_repo;
      this.compare_entity = Audio_Data_History_Repo_Insert_Test.compare_entity;
      this.just_entity = Audio_Data_History_Repo_Insert_Test.just_entity;
      this.softly = Audio_Data_History_Repo_Insert_Test.softly;

      Audio_Data_History_Repo_Insert_Test.testcase.historyDatabaseReset(false);
    }
    ...
    public void 新規追加の成功ケース(){
      ...
      for(Audio_Data_History ent: this.compare_entity){
        ent.setHistory_id(null);
        this.test_repo.save(ent);

        List<Audio_Data_History> result = (List<Audio_Data_History>)this.test_repo.findAll();
      ...
      List<Audio_Data_History> after = (List<Audio_Data_History>)this.test_repo.findAll();
  ...
  public class Insert_Failed {
    ...
    private final Audio_Data_History_Repo test_repo;
    private final List<Audio_Data_History> failed_entity;
    ...
    public Insert_Failed() throws IOException{
      this.test_repo = Audio_Data_History_Repo_Insert_Test.test_repo;
      this.failed_entity = Audio_Data_History_Repo_Insert_Test.failed_entity;
      this.softly = Audio_Data_History_Repo_Insert_Test.softly;
    ...
    public void 新規追加の失敗ケース(){
      ...
      for(Audio_Data_History ent: this.failed_entity){
        ent.setHistory_id(null);

/** 
 **************************************************************************************
 * @file Score_Pdf_Enum_Test.java
 * 
 * @brief 主に[楽譜データ管理]機能において使用する列挙型をテストするクラスを格納したファイルである。
 **************************************************************************************
 */ 
...
/** 
 **************************************************************************************
 * @brief 主に[楽譜データ管理]機能において使用する列挙型をテストするクラス。
 * 
 * @details 
 * - 検査対象の列挙型名は[Score_Pdf_Enum]である。
 ...
 **************************************************************************************
 */ 
public class Score_Pdf_Enum_Test implements Normal_Enum_Test{
  ...
  private static Score_Pdf_Enum[] enumlist;
  ...
  public static void setUp(){
    Score_Pdf_Enum_Test.enumlist = Score_Pdf_Enum.values();
  }
  ...
  public void 各列挙型項目の日本語項目名の一致テスト(){
    ...
    for(int i = 0; i < size; i++){
      this.softly.assertThat(Score_Pdf_Enum_Test.enumlist[i].getJaName())
  ...
  public void 各列挙型項目の英語項目名の一致テスト(){
    ...
    for(int i = 0; i < size; i++){
      this.softly.assertThat(Score_Pdf_Enum_Test.enumlist[i].getEnName())

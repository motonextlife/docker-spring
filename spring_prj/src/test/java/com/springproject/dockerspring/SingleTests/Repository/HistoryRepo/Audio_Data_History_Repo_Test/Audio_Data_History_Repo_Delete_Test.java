/** 
 **************************************************************************************
 * @package com.springproject.dockerspring.SingleTests.Repository
 * 
 * @brief 単体テストのうち、[データベース通信のリポジトリ]に関するテストを格納するパッケージ
 * 
 * @details
 * - このパッケージは、システム全体で用いる、データベースからのデータの取得などの通信を取り扱う
 * リポジトリクラスのテストを格納する。
 **************************************************************************************
 */ 
...
/** 
 **************************************************************************************
 * @package com.springproject.dockerspring.SingleTests.Repository.HistoryRepo
 * 
 * @brief リポジトリの単体テストのうち、[履歴用リポジトリ]に関するテストを格納するパッケージ
 * 
 * @details
 * - このパッケージは、履歴用のリポジトリの検索メソッドやデータ更新メソッドの動作確認を行う
 * テストを格納する。
 **************************************************************************************
 */ 
 ...
 * 
 * @brief 履歴用リポジトリのうち、[音源データ情報変更履歴]に関するテストを格納するパッケージ
 * 
 * @details
...
/** 
 **************************************************************************************
 * @file Audio_Data_History_Repo_Delete_Test.java
 * @brief 主に[音源データ変更履歴]のリポジトリクラスで、データの削除を行うメソッドのテストを行う
 * クラスを格納したファイル。
 * 
 * @note
...
/** 
 **************************************************************************************
 * @brief 主に[音源データ変更履歴]のリポジトリクラスで、データの削除を行うメソッドのテストを
 * 行うクラス
 * 
 * @details 
...
public class Audio_Data_History_Repo_Delete_Test{
  ...
  public void testcaseSetup(Audio_Data_TestCase_Make testcase, 
                            Audio_Data_History_Repo test_repo) throws IOException{

    Audio_Data_History_Repo_Delete_Test.testcase = testcase;
    Audio_Data_History_Repo_Delete_Test.test_repo = test_repo;
    ...
    Audio_Data_History_Repo_Delete_Test.compare_entity = compare_entity;
  }
  ...
  public class Delete_Success {
    ...
    public Delete_Success() throws IOException{
      this.test_repo = Audio_Data_History_Repo_Delete_Test.test_repo;
      this.compare_entity = Audio_Data_History_Repo_Delete_Test.compare_entity;
      this.softly = Audio_Data_History_Repo_Delete_Test.softly;

      Audio_Data_History_Repo_Delete_Test.testcase.historyDatabaseSetup(false);
    }
    ...
    public void 削除の成功ケース(){
      ...
      for(int i = 0; i < 10; i++){
        Audio_Data_History del_ent = this.compare_entity.get(i);
      ...
      for(int i = 10; i < 20; i++){
        Audio_Data_History no_delete = this.compare_entity.get(i);

        Audio_Data_History result = this.test_repo.findById(no_delete.getSerial_num()).get();
    ...
    public static void testcaseReset() throws IOException{
      Audio_Data_History_Repo_Delete_Test.testcase.historyDatabaseReset(false);
    }
  }
}

/** 
 **************************************************************************************
 * @file System_User_Enum_Test.java
 * 
 * @brief 主に[システムユーザー管理]機能において使用する列挙型をテストするクラスを格納したファイル
 * である。
 **************************************************************************************
 */ 
...
/** 
 **************************************************************************************
 * @brief 主に[システムユーザー管理]機能において使用する列挙型をテストするクラス。
 * 
 * @details 
 * - 検査対象の列挙型名は[System_User_Enum]である。
 ...
 **************************************************************************************
 */ 
public class System_User_Enum_Test implements Normal_Enum_Test{
  ...
  private static System_User_Enum[] enumlist;
  ...
  public static void setUp(){
    System_User_Enum_Test.enumlist = System_User_Enum.values();
  }
  ...
  public void 各列挙型項目の日本語項目名の一致テスト(){
    ...
    for(int i = 0; i < size; i++){
      this.softly.assertThat(System_User_Enum_Test.enumlist[i].getJaName())
  ...
  public void 各列挙型項目の英語項目名の一致テスト(){
    ...
    for(int i = 0; i < size; i++){
      this.softly.assertThat(System_User_Enum_Test.enumlist[i].getEnName())

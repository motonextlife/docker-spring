/** 
 **************************************************************************************
 * @file Member_Info_History_Repo_FindAllBranch_Test.java
 * @brief 主に[団員情報変更履歴]のリポジトリクラスで、検索メソッドの分岐と実行を行うメソッドの
 * テストを行うクラスを格納したファイル。
 **************************************************************************************
 */ 
...
public class Member_Info_History_Repo_FindAllBranch_Test{
   ...
   */
  @Autowired
  public Member_Info_History_Repo_FindAllBranch_Test(Member_Info_History_Repo test_repo, 
  ...
  private void configStaticSet(){
    Member_Info_History_Repo_FindAllBranch_Test.testcase_static = this.testcase;
  }
   ...
   **********************************************************************************************
   */
  private void findAllBranchCheck(TestParamBuilder<Member_Info_History> test_builder) 
  ...
  public void 検索分岐メソッドにおいて検索種別が履歴日時の際のテスト() throws InterruptedException, ExecutionException, ParseException{
    ...
    for(int i = 1; i <= 20; i++){
      ...
      TestParam<Member_Info_History> test_builder = TestParam.<Member_Info_History>builder()
  ...
  public static void testcaseReset() throws IOException{
    Member_Info_History_Repo_FindAllBranch_Test.testcase_static.historyDatabaseReset();
  }
}

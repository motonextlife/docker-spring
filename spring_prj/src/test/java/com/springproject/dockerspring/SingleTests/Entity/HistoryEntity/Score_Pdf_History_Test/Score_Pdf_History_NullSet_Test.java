/** 
 **************************************************************************************
 * @file Score_Pdf_History_NullSet_Test.java
 * 
 * @brief  [楽譜データ変更履歴]において、エンティティ内部に格納されているデータをNull初期化する
 ...
 * 
 * @details 
 * - 検査対象のクラス名は[Score_Pdf_History]で、検査対象メソッドは[stringSetNull]である。
 ...
 **************************************************************************************
 */ 
public class Score_Pdf_History_NullSet_Test implements Entity_NullSet_Test{
   ...
   ****************************************************************************************
   */ 
  private void assertAllNull(Score_Pdf_History entity){
    ...
    this.softly.assertThat(entity.getScore_name()).isNull();
    this.softly.assertThat(entity.getPdf_hash()).isNull();
  }

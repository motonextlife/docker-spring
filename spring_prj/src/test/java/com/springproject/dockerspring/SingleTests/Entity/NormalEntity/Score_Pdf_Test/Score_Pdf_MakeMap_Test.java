/** 
 **************************************************************************************
 * @package com.springproject.dockerspring.SingleTests.Entity.NormalEntity.Score_Pdf_Test
 * 
 * @brief 通常用エンティティのうち、[楽譜データ管理]に関するテストを格納するパッケージ
 * 
 * @details
 * - このパッケージは、楽譜データ管理のテストを行うクラスを格納する。
 **************************************************************************************
 */ 
package com.springproject.dockerspring.SingleTests.Entity.NormalEntity.Score_Pdf_Test;
...
/** 
 **************************************************************************************
 * @file Score_Pdf_MakeMap_Test.java
 * 
 * @brief [楽譜管理]において、エンティティ内部のデータを画面出力用に文字列に変換して出力する
 ...
 * 
 * @details 
 * - 検査対象のクラス名は[Score_Pdf]で、検査対象メソッドは[makeMap]である。
...
public class Score_Pdf_MakeMap_Test implements Entity_MakeMap_Test{
  ...
  private void setInitTargetEntity(String str){
    ...
    Score_Pdf entity = new Score_Pdf();
  ...
  public void 入力した文字列マップリストデータの同一性確認(){
    ...
    compare_map.put("score_name", score_name);

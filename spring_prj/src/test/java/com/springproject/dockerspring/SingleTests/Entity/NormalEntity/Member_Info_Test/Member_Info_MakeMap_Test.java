/** 
 **************************************************************************************
 * @file Member_Info_MakeMap_Test.java
 * 
 * @brief [団員管理]において、エンティティ内部のデータを画面出力用に文字列に変換して出力する
 ...
 * 
 * @details 
 * - 検査対象のクラス名は[Member_Info]で、検査対象メソッドは[makeMap]である。
...
public class Member_Info_MakeMap_Test implements Entity_MakeMap_Test{

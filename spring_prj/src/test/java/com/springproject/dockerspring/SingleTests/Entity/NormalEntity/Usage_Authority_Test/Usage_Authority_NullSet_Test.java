/** 
 **************************************************************************************
 * @file Usage_Authority_NullSet_Test.java
 * 
 * @brief [権限管理]において、エンティティ内部に格納されているデータをNull初期化するメソッドを
 ...
 * 
 * @details 
 * - 検査対象のクラス名は[Usage_Authority]で、検査対象メソッドは[stringSetNull]である。
 ...
 **************************************************************************************
 */ 
public class Usage_Authority_NullSet_Test implements Entity_NullSet_Test{
   ...
   * - 権限情報が初期化対象だった場合、「全ての権限がない」状態になる。
   ****************************************************************************************
   */ 

/** 
 **************************************************************************************
 * @file Sound_Source_History_Repo_FindAllBranch_Test.java
 * @brief 主に[音源情報変更履歴]のリポジトリクラスで、検索メソッドの分岐と実行を行うメソッドの
 * テストを行うクラスを格納したファイル。
 **************************************************************************************
 */ 
...
public class Sound_Source_History_Repo_FindAllBranch_Test{
   ...
   */
  @Autowired
  public Sound_Source_History_Repo_FindAllBranch_Test(Sound_Source_History_Repo test_repo, 
  ...
  private void configStaticSet(){
    Sound_Source_History_Repo_FindAllBranch_Test.testcase_static = this.testcase;
  }
   ...
   **********************************************************************************************
   */
  private void findAllBranchCheck(TestParamBuilder<Sound_Source_History> test_builder) 
  ...
  public void 検索分岐メソッドにおいて検索種別が履歴日時の際のテスト() throws InterruptedException, ExecutionException, ParseException{
    ...
    for(int i = 1; i <= 20; i++){
      ...
      TestParam<Sound_Source_History> test_builder = TestParam.<Sound_Source_History>builder()
  ...
  public static void testcaseReset() throws IOException{
    Sound_Source_History_Repo_FindAllBranch_Test.testcase_static.historyDatabaseReset();
  }
}

/** 
 **************************************************************************************
 * @file Score_Pdf_History_Repo_FindAllBranch_Test.java
 * @brief 主に[楽譜データ変更履歴]のリポジトリクラスで、検索メソッドの分岐と実行を行うメソッドの
 * テストを行うクラスを格納したファイル。
 **************************************************************************************
 */ 
...
public class Score_Pdf_History_Repo_FindAllBranch_Test{
   ...
   */
  @Autowired
  public Score_Pdf_History_Repo_FindAllBranch_Test(Score_Pdf_History_Repo test_repo, 
  ...
  private void configStaticSet(){
    Score_Pdf_History_Repo_FindAllBranch_Test.testcase_static = this.testcase;
  }
   ...
   **********************************************************************************************
   */
  private void findAllBranchCheck(TestParamBuilder<Score_Pdf_History> test_builder) 
  ...
  public void 検索分岐メソッドにおいて検索種別が履歴日時の際のテスト() throws InterruptedException, ExecutionException, ParseException{
    ...
    for(int i = 1; i <= 20; i++){
      ...
      TestParam<Score_Pdf_History> test_builder = TestParam.<Score_Pdf_History>builder()
  ...
  public static void testcaseReset() throws IOException{
    Score_Pdf_History_Repo_FindAllBranch_Test.testcase_static.historyDatabaseReset(false);
  }
}

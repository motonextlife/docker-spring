 ...
 * 
 * @brief 通常用エンティティのうち、[設備写真データ管理]に関するテストを格納するパッケージ
 * 
 * @details
 * - このパッケージは、設備写真データ管理のテストを行うクラスを格納する。
 **************************************************************************************
 */ 
package com.springproject.dockerspring.SingleTests.Entity.NormalEntity.Facility_Photo_Test;
...
/** 
 **************************************************************************************
 * @file Facility_Photo_MakeMap_Test.java
 * 
 * @brief [設備写真データ管理]において、エンティティ内部のデータを画面出力用に文字列に変換して
 ...
 * 
 * @details 
 * - 検査対象のクラス名は[Facility_Photo]で、検査対象メソッドは[makeMap]である。
...
public class Facility_Photo_MakeMap_Test implements Entity_MakeMap_Test{

/** 
 **************************************************************************************
 * @file Musical_Score_History_NullSet_Test.java
 * 
 * @brief  [楽譜情報変更履歴]において、エンティティ内部に格納されているデータをNull初期化する
 ...
 * 
 * @details 
 * - 検査対象のクラス名は[Musical_Score_History]で、検査対象メソッドは[stringSetNull]である。
 ...
 **************************************************************************************
 */ 
public class Musical_Score_History_NullSet_Test implements Entity_NullSet_Test{

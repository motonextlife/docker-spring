 ...
 * 
 * @brief 履歴用エンティティのうち、[音源情報変更履歴]に関するテストを格納するパッケージ
 * 
 * @details
...
/** 
 **************************************************************************************
 * @file Sound_Source_History_MakeMap_Test.java
 * 
 * @brief [音源情報変更履歴]において、エンティティ内部のデータを画面出力用に文字列に変換して
 ...
 * 
 * @details 
 * - 検査対象のクラス名は[Sound_Source_History]で、検査対象メソッドは[makeMap]である。
...
public class Sound_Source_History_MakeMap_Test implements Entity_MakeMap_Test{
  ...
  private void setInitTargetEntity(String str){
    ...
    Sound_Source_History entity = new Sound_Source_History();

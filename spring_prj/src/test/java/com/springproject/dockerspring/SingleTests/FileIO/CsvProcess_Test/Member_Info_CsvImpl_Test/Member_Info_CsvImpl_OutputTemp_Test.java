/** 
 **************************************************************************************
 * @file Member_Info_CsvImpl_OutputTemp_Test.java
 * @brief 主に[団員管理]のCSVテンプレート出力機能のテストを行うクラスを格納したファイル。
 * 
...
/** 
 **************************************************************************************
 * @brief 主に[団員管理]のCSVテンプレート出力機能のテストを行うクラス
 * 
 * @details 
...
public class Member_Info_CsvImpl_OutputTemp_Test implements CsvProcess_OutputTemp_Test{
  ...
  private final String prefix = "MemberInfoCsvImplOutputTempTest";
   ...
   */
  @Autowired
  public Member_Info_CsvImpl_OutputTemp_Test(Member_Info_TestCase_Make testcase){
  ...
  public void 集約クラス側のCSVテンプレート出力機能の動作確認() throws IOException{
    ...
    File tmp_file_path = this.member_csv.outputTemplate();

/** 
 **************************************************************************************
 * @file Facility_Photo_Repo_Insert_Test.java
 * @brief 主に[設備写真データ管理]のリポジトリクラスで、データの新規追加を行うメソッドのテストを行う
 * クラスを格納したファイル。
 **************************************************************************************
 */ 
...
/** 
 **************************************************************************************
 * @brief 主に[設備写真データ管理]のリポジトリクラスで、データの新規追加を行うメソッドのテストを
 * 行うクラス
 * 
 * @details 
...
public class Facility_Photo_Repo_Insert_Test{
  ...
  public void testcaseSetup(Facility_Photo_TestCase_Make testcase, 
    ...
    Facility_Photo_Repo_Insert_Test.testcase = testcase;
    Facility_Photo_Repo_Insert_Test.foreign_case = foreign_case;
    Facility_Photo_Repo_Insert_Test.test_repo = test_repo;
    Facility_Photo_Repo_Insert_Test.foreign_repo = foreign_repo;
    ...
    for(int i = 1; i <= 20; i++){
     ...
     Facility_Photo_Repo_Insert_Test.compare_entity = compare_entity;
     Facility_Photo_Repo_Insert_Test.just_entity = Facility_Quad_Repository_TestUtils
                                                   .MockToReal(testcase.justInTimeEntityMake());


    List< Facility_Photo> failed_ent_tmp = testcase.failedEntityMake();
     Facility_Photo_Repo_Insert_Test.failed_entity = new ArrayList<>();

    for( Facility_Photo fail_ent: failed_ent_tmp){
       Facility_Photo_Repo_Insert_Test.failed_entity.add(Facility_Quad_Repository_TestUtils.MockToReal(fail_ent));
    }
  }
  ...
  public class Insert_Success {
    ...
    public Insert_Success() throws IOException{
      this.test_repo = Facility_Photo_Repo_Insert_Test.test_repo;
      this.compare_entity = Facility_Photo_Repo_Insert_Test.compare_entity;
      this.just_entity = Facility_Photo_Repo_Insert_Test.just_entity;
      this.softly = Facility_Photo_Repo_Insert_Test.softly;

      Facility_Photo_Repo_Insert_Test.testcase.databaseReset(false);
      Facility_Photo_Repo_Insert_Test.foreign_case.databaseSetup();
      ...
      Facility_Photo_Repo_Insert_Test.foreign_repo.save(foreign_just_entity);
    }
    ...
    public void 新規追加の成功ケース(){
      ...
      for(Facility_Photo ent: this.compare_entity){
        ent.setSerial_num(null);
        this.test_repo.save(ent);

        List<Facility_Photo> result = (List<Facility_Photo>)this.test_repo.findAll();
      ...
      List<Facility_Photo> after = (List<Facility_Photo>)this.test_repo.findAll();
    ...
    public static void testcaseReset() throws IOException{
      Facility_Photo_Repo_Insert_Test.testcase.databaseReset(false);
      Facility_Photo_Repo_Insert_Test.foreign_case.databaseReset();
    }
  }
  ...
  public class Insert_Failed {
    ...
    public Insert_Failed() throws IOException{
      this.test_repo = Facility_Photo_Repo_Insert_Test.test_repo;
      this.failed_entity = Facility_Photo_Repo_Insert_Test.failed_entity;
      this.softly = Facility_Photo_Repo_Insert_Test.softly;

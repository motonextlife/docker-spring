/** 
 **************************************************************************************
 * @file Sound_Source_History_Repo_SearchCount_Test.java
 * @brief 主に[音源情報変更履歴]のリポジトリクラスで、独自に追加した検索結果を取得するメソッドと
...
public class Sound_Source_History_Repo_SearchCount_Test{
  ...
  private final List<Sound_Source_History> origin_compare;
   ...
   */
  @Autowired
  public Sound_Source_History_Repo_SearchCount_Test(Sound_Source_History_Repo test_repo, 
  ...
  private void configStaticSet(){
    Sound_Source_History_Repo_SearchCount_Test.testcase_static = this.testcase;
  }
   ...
   **********************************************************************************************
   */
  private void findAllSearchCheck(Function<TestParam<Sound_Source_History>, CompletableFuture<List<Sound_Source_History>>> find_all_method, 
                                  TestParamBuilder<Sound_Source_History> test_builder) 
                                  throws ExecutionException, InterruptedException{

    BiConsumer<Sound_Source_History, Sound_Source_History> assert_method = (compare, result) -> {
      Sound_Quad_Repository_TestUtils.assertAllEquals(compare, result, this.softly, true);
    };

    TestParam<Sound_Source_History> test_param = test_builder.assert_method(assert_method)
                                                             .softly(this.softly)
                                                             .build();
  ...
  public void 検索対象のカラムが履歴日時の際のテスト() throws InterruptedException, ExecutionException, ParseException{
    ...
    for(int i = 1; i <= 20; i++){
      ...
      CompareParam<Sound_Source_History> list_builder = CompareParam
                                         .<Sound_Source_History>builder()
      ...
      List<Sound_Source_History> compare_1 = Common_Repository_TestUtils
                                 .compareListMake(list_builder.toBuilder()
                                                              .sort_first(Comparator.comparing(Sound_Source_History::getChange_datetime))
                                                              .sort_second(Comparator.comparing(Sound_Source_History::getHistory_id))
                                                              .build());
      List<Sound_Source_History> compare_2 = Common_Repository_TestUtils
                                 .compareListMake(list_builder.toBuilder()
                                                              .sort_first(Comparator.comparing(Sound_Source_History::getChange_datetime, 
      ...
      Function<TestParam<Sound_Source_History>, CompletableFuture<List<Sound_Source_History>>> find_all_method_1 = s -> {
        return this.test_repo.findAllByDateBetween(s.getStart_datetime(), s.getEnd_datetime(), s.getLimit(), s.getOffset());
      };

      Function<TestParam<Sound_Source_History>, CompletableFuture<List<Sound_Source_History>>> find_all_method_2 = s -> {
        return this.test_repo.findAllByDateBetweenDESC(s.getStart_datetime(), s.getEnd_datetime(), s.getLimit(), s.getOffset());
      };

      TestParam<Sound_Source_History> test_builder = TestParam.<Sound_Source_History>builder().start_datetime(start)
                                                                                              .end_datetime(end)
                                                                                              .limit(limit)
                                                                                              .offset(offset)
                                                                                              .all_judge(true)
  ...
  /** 
   **********************************************************************************************
   * @brief リポジトリメソッド[findBySound_id][findBySound_idDESC]を実行した際の
   * 検索結果を判定する。
   *
   * @details
   * - テストの内容としては、検索ワードを渡してメソッドを実行した際に、想定された検索結果と、テスト対象メソッド
   ...
   */
  @Test
  public void 検索対象のカラムが音源番号の際のテスト() throws InterruptedException, ExecutionException, ParseException{
    ...
    for(int i = 1; i <= 20; i++){
      ...
      List<Sound_Source_History> compare_1 = Common_Repository_TestUtils
                                 .compareListMake(list_builder.toBuilder()
                                                              .sort_first(Comparator.comparing(Sound_Source_History::getSound_id))
                                                              .sort_second(Comparator.comparing(Sound_Source_History::getChange_datetime))
                                                              .sort_third(Comparator.comparing(Sound_Source_History::getHistory_id))
                                                              .build());
      List<Sound_Source_History> compare_2 = Common_Repository_TestUtils
                                 .compareListMake(list_builder.toBuilder()
                                                              .sort_first(Comparator.comparing(Sound_Source_History::getSound_id, 
      ...
      Function<TestParam<Sound_Source_History>, CompletableFuture<List<Sound_Source_History>>> find_all_method_1 = s -> {
        return this.test_repo.findBySound_id(s.getMain_word(), s.getStart_datetime(), s.getEnd_datetime(), 
                                             s.getLimit(), s.getOffset());
      };

      Function<TestParam<Sound_Source_History>, CompletableFuture<List<Sound_Source_History>>> find_all_method_2 = s -> {
        return this.test_repo.findBySound_idDESC(s.getMain_word(), s.getStart_datetime(), s.getEnd_datetime(), 
                                                 s.getLimit(), s.getOffset());
      };

      TestParam<Sound_Source_History> test_builder = TestParam.<Sound_Source_History>builder().main_word(word)
  ...
  public void 検索対象のカラムが操作ユーザー名の際のテスト() throws InterruptedException, ExecutionException, ParseException{
    ...
    for(int i = 1; i <= 20; i++){
      ...
      List<Sound_Source_History> compare_1 = Common_Repository_TestUtils
                                 .compareListMake(list_builder.toBuilder()
                                                              .sort_first(Comparator.comparing(Sound_Source_History::getOperation_user))
                                                              .sort_second(Comparator.comparing(Sound_Source_History::getChange_datetime))
                                                              .sort_third(Comparator.comparing(Sound_Source_History::getHistory_id))
                                                              .build());
      List<Sound_Source_History> compare_2 = Common_Repository_TestUtils
   ...
   */
  @Test
  public void カウント対象のカラムが音源番号の際のテスト() throws InterruptedException, ExecutionException, ParseException{
    ...
    for(int i = 1; i <= 20; i++){
      ...
      CompletableFuture<Integer> result_1 = this.test_repo.findBySound_idCount(word, start, end, limit);
      CompletableFuture<Integer> result_2 = this.test_repo.findBySound_idCount(word, start, null, limit);
      CompletableFuture<Integer> result_3 = this.test_repo.findBySound_idCount(word, null, end, limit);
      CompletableFuture<Integer> result_4 = this.test_repo.findBySound_idCount(null, start, end, limit);
      CompletableFuture<Integer> result_5 = this.test_repo.findBySound_idCount(word, start, end, null);
  ...
  public static void testcaseReset() throws IOException{
    Sound_Source_History_Repo_SearchCount_Test.testcase_static.historyDatabaseReset();
  }
}

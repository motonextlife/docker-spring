/** 
 **************************************************************************************
 * @file Score_Pdf_Repo_Insert_Test.java
 * @brief 主に[楽譜データ管理]のリポジトリクラスで、データの新規追加を行うメソッドのテストを行う
 * クラスを格納したファイル。
 **************************************************************************************
 */ 
...
/** 
 **************************************************************************************
 * @brief 主に[楽譜データ管理]のリポジトリクラスで、データの新規追加を行うメソッドのテストを
 * 行うクラス
 * 
 * @details 
 ...
 **************************************************************************************
 */ 
@Import({Score_Pdf_TestCase_Make.class, Musical_Score_TestCase_Make.class})
@DataJdbcTest
@AutoConfigureTestDatabase(replace = Replace.NONE)
public class Score_Pdf_Repo_Insert_Test{
  ...
  public void testcaseSetup(Score_Pdf_TestCase_Make testcase, 
    ...
    Score_Pdf_Repo_Insert_Test.testcase = testcase;
    Score_Pdf_Repo_Insert_Test.foreign_case = foreign_case;
    Score_Pdf_Repo_Insert_Test.test_repo = test_repo;
    Score_Pdf_Repo_Insert_Test.foreign_repo = foreign_repo;
    ...
    Score_Pdf_Repo_Insert_Test.compare_entity = compare_entity;
    Score_Pdf_Repo_Insert_Test.just_entity = Score_Quad_Repository_TestUtils
                                             .MockToReal(testcase.justInTimeEntityMake());


    List<Score_Pdf> failed_ent_tmp = testcase.failedEntityMake();
    Score_Pdf_Repo_Insert_Test.failed_entity = new ArrayList<>();

    for(Score_Pdf fail_ent: failed_ent_tmp){
      Score_Pdf_Repo_Insert_Test.failed_entity.add(Score_Quad_Repository_TestUtils.MockToReal(fail_ent));
    }
  }
  ...
  public class Insert_Success {
    ...
    public Insert_Success() throws IOException{
      this.test_repo = Score_Pdf_Repo_Insert_Test.test_repo;
      this.compare_entity = Score_Pdf_Repo_Insert_Test.compare_entity;
      this.just_entity = Score_Pdf_Repo_Insert_Test.just_entity;
      this.softly = Score_Pdf_Repo_Insert_Test.softly;

      Score_Pdf_Repo_Insert_Test.testcase.databaseReset(false);
      Score_Pdf_Repo_Insert_Test.foreign_case.databaseSetup();
      ...
      Score_Pdf_Repo_Insert_Test.foreign_repo.save(foreign_just_entity);
    }
    ...
    public void 新規追加の成功ケース(){
      ...
      for(Score_Pdf ent: this.compare_entity){
        ent.setSerial_num(null);
        this.test_repo.save(ent);

        List<Score_Pdf> result = (List<Score_Pdf>)this.test_repo.findAll();
      ...
      List<Score_Pdf> after = (List<Score_Pdf>)this.test_repo.findAll();
    ...
    public static void testcaseReset() throws IOException{
      Score_Pdf_Repo_Insert_Test.testcase.databaseReset(false);
      Score_Pdf_Repo_Insert_Test.foreign_case.databaseReset();
    }
  }
  ...
  public class Insert_Failed {
    ...
    public Insert_Failed() throws IOException{
      this.test_repo = Score_Pdf_Repo_Insert_Test.test_repo;
      this.failed_entity = Score_Pdf_Repo_Insert_Test.failed_entity;
      this.softly = Score_Pdf_Repo_Insert_Test.softly;

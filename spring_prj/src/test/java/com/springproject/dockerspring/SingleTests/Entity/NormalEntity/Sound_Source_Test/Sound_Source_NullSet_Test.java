/** 
 **************************************************************************************
 * @file Sound_Source_NullSet_Test.java
 * 
 * @brief [音源管理]において、エンティティ内部に格納されているデータをNull初期化するメソッドを
 ...
 * 
 * @details 
 * - 検査対象のクラス名は[Sound_Source]で、検査対象メソッドは[stringSetNull]である。
 ...
 **************************************************************************************
 */ 
public class Sound_Source_NullSet_Test implements Entity_NullSet_Test{

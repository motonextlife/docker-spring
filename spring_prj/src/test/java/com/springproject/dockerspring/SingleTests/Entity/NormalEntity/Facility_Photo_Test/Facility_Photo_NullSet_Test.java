/** 
 **************************************************************************************
 * @file Facility_Photo_NullSet_Test.java
 * 
 * @brief [設備写真データ管理]において、エンティティ内部に格納されているデータをNull初期化する
 ...
 **************************************************************************************
 */ 
package com.springproject.dockerspring.SingleTests.Entity.NormalEntity.Facility_Photo_Test;
 ...
 * 
 * @details 
 * - 検査対象のクラス名は[Facility_Photo]で、検査対象メソッドは[stringSetNull]である。
 ...
 **************************************************************************************
 */ 
public class Facility_Photo_NullSet_Test implements Entity_NullSet_Test{
  ...
  private void setInitTargetEntity(String str){
    ...
    Facility_Photo entity = new Facility_Photo();
    entity.setFaci_id(str);
    entity.setPhoto_name(str);
    entity.setPhoto_hash(str);
   ...
   ****************************************************************************************
   */ 
  private void assertAllNull(Facility_Photo entity){
    this.softly.assertThat(entity.getSerial_num()).isNull();
    this.softly.assertThat(entity.getFaci_id()).isNull();
    this.softly.assertThat(entity.getPhoto_name()).isNull();
    this.softly.assertThat(entity.getPhoto_hash()).isNull();
  }

/** 
 **************************************************************************************
 * @file Member_Info_Repo_Insert_Test.java
 * @brief 主に[団員管理]のリポジトリクラスで、データの新規追加を行うメソッドのテストを行う
 * クラスを格納したファイル。
 **************************************************************************************
 */ 
...
/** 
 **************************************************************************************
 * @brief 主に[団員管理]のリポジトリクラスで、データの新規追加を行うメソッドのテストを
 * 行うクラス
 * 
 * @details 
...
public class Member_Info_Repo_Insert_Test{
   ...
   */
  @Autowired
  public void testcaseSetup(Member_Info_TestCase_Make testcase, Member_Info_Repo test_repo) throws IOException{

    Member_Info_Repo_Insert_Test.testcase = testcase;
    Member_Info_Repo_Insert_Test.test_repo = test_repo;
    ...
    Member_Info_Repo_Insert_Test.compare_entity = compare_entity;
    Member_Info_Repo_Insert_Test.just_entity = Member_Quad_Repository_TestUtils
                                               .MockToReal(testcase.justInTimeEntityMake());
    Member_Info_Repo_Insert_Test.null_entity = Member_Quad_Repository_TestUtils
                                               .MockToReal(testcase.okNullEntityMake());
    Member_Info_Repo_Insert_Test.unique_miss = Member_Quad_Repository_TestUtils
                                               .MockToReal(testcase.UniqueMissEntityMake());

    List<Member_Info> failed_ent_tmp = testcase.failedEntityMake();
    Member_Info_Repo_Insert_Test.failed_entity = new ArrayList<>();

    for(Member_Info fail_ent: failed_ent_tmp){
      Member_Info_Repo_Insert_Test.failed_entity.add(Member_Quad_Repository_TestUtils.MockToReal(fail_ent));
    }
  }
  ...
  public class Insert_Success {
    ...
    public Insert_Success() throws IOException{
      this.test_repo = Member_Info_Repo_Insert_Test.test_repo;
      this.compare_entity = Member_Info_Repo_Insert_Test.compare_entity;
      this.just_entity = Member_Info_Repo_Insert_Test.just_entity;
      this.null_entity = Member_Info_Repo_Insert_Test.null_entity;
      this.softly = Member_Info_Repo_Insert_Test.softly;

      Member_Info_Repo_Insert_Test.testcase.databaseReset();
    }
    ...
    public void 新規追加の成功ケース(){
      ...
      for(Member_Info ent: this.compare_entity){
        ent.setSerial_num(null);
        this.test_repo.save(ent);

        List<Member_Info> result = (List<Member_Info>)this.test_repo.findAll();
      ...
      List<Member_Info> after = (List<Member_Info>)this.test_repo.findAll();
      ...
      List<Member_Info> nulled = (List<Member_Info>)this.test_repo.findAll();
  ...
  public class Insert_Failed {
    ...
    public Insert_Failed() throws IOException{
      this.test_repo = Member_Info_Repo_Insert_Test.test_repo;
      this.failed_entity = Member_Info_Repo_Insert_Test.failed_entity;
      this.softly = Member_Info_Repo_Insert_Test.softly;
  ...
  public class Unique_Failed {
    ...
    public Unique_Failed() throws IOException{
      this.test_repo = Member_Info_Repo_Insert_Test.test_repo;
      this.unique_miss = Member_Info_Repo_Insert_Test.unique_miss;
      this.softly = Member_Info_Repo_Insert_Test.softly;

      Member_Info_Repo_Insert_Test.testcase.databaseSetup();
    }

/** 
 **************************************************************************************
 * @file Musical_Score_History_Repo_Insert_Test.java
 * @brief 主に[楽譜情報変更履歴]のリポジトリクラスで、データの新規追加を行うメソッドのテストを行う
 * クラスを格納したファイル。
 **************************************************************************************
 */ 
...
/** 
 **************************************************************************************
 * @brief 主に[楽譜情報変更履歴]のリポジトリクラスで、データの新規追加を行うメソッドのテストを
 * 行うクラス
 * 
 * @details 
...
public class Musical_Score_History_Repo_Insert_Test{
  ...
  public static Musical_Score_History just_entity;
  public static Musical_Score_History null_entity;
  public static List<Musical_Score_History> failed_entity;
   ...
   */
  @Autowired
  public void testcaseSetup(Musical_Score_TestCase_Make testcase, Musical_Score_History_Repo test_repo){
    Musical_Score_History_Repo_Insert_Test.testcase = testcase;
    Musical_Score_History_Repo_Insert_Test.test_repo = test_repo;
    ...
    Musical_Score_History_Repo_Insert_Test.compare_entity = compare_entity;
    Musical_Score_History_Repo_Insert_Test.just_entity = Score_Quad_Repository_TestUtils
                                                         .MockToReal(testcase.justInTimeHistoryEntityMake());
    Musical_Score_History_Repo_Insert_Test.null_entity = Score_Quad_Repository_TestUtils
                                                         .MockToReal(testcase.okNullHistoryEntityMake());

    List<Musical_Score_History> failed_ent_tmp = testcase.failedHistoryEntityMake();
    Musical_Score_History_Repo_Insert_Test.failed_entity = new ArrayList<>();

    for(Musical_Score_History fail_ent: failed_ent_tmp){
      Musical_Score_History_Repo_Insert_Test.failed_entity.add(Score_Quad_Repository_TestUtils.MockToReal(fail_ent));
    }
  }
  ...
  public class Insert_Success {
    ...
    private final Musical_Score_History just_entity;
    private final Musical_Score_History null_entity;
    ...
    public Insert_Success() throws IOException{
      this.test_repo = Musical_Score_History_Repo_Insert_Test.test_repo;
      this.compare_entity = Musical_Score_History_Repo_Insert_Test.compare_entity;
      this.just_entity = Musical_Score_History_Repo_Insert_Test.just_entity;
      this.null_entity = Musical_Score_History_Repo_Insert_Test.null_entity;
      this.softly = Musical_Score_History_Repo_Insert_Test.softly;

      Musical_Score_History_Repo_Insert_Test.testcase.historyDatabaseReset();
    }
    ...
    public void 新規追加の成功ケース(){
      ...
      for(Musical_Score_History ent: this.compare_entity){
        ent.setHistory_id(null);
        this.test_repo.save(ent);

        List<Musical_Score_History> result = (List<Musical_Score_History>)this.test_repo.findAll();
      ...
      List<Musical_Score_History> after = (List<Musical_Score_History>)this.test_repo.findAll();
      ...
      List<Musical_Score_History> nulled = (List<Musical_Score_History>)this.test_repo.findAll();
      Score_Quad_Repository_TestUtils.assertAllEquals(this.null_entity, nulled.get(0), this.softly, false);
  ...
  public class Insert_Failed {
    ...
    private final Musical_Score_History_Repo test_repo;
    private final List<Musical_Score_History> failed_entity;
    ...
    public Insert_Failed() throws IOException{
      this.test_repo = Musical_Score_History_Repo_Insert_Test.test_repo;
      this.failed_entity = Musical_Score_History_Repo_Insert_Test.failed_entity;
      this.softly = Musical_Score_History_Repo_Insert_Test.softly;
    ...
    public void 新規追加の失敗ケース(){
      ...
      for(Musical_Score_History ent: this.failed_entity){
        ent.setHistory_id(null);

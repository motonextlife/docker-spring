...
public class Member_Info_PdfImpl_MakePdf_Test implements PdfProcess_MakePdf_Test{
  ...
  private final Member_Info_Pdf score_pdf;
  ...
  public void PDF出力機能の動作確認と生成ファイルの存在確認() throws IOException, ParseException{
    ...
    Member_Info mock_ent = this.testcase.compareEntityMake(1);
    mock_ent = Member_Info_Component_TestUtils.methodMockMakeMap(mock_ent);
